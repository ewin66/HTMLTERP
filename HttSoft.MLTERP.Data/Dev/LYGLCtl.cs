...
namespace HttSoft.MLTERP.DataCtl
{
	...
	/// 创建日期:2012/10/26
	/// </summary>
	public sealed class LYGLCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public LYGLCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Dev_LYGL SET ");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Dev_LYGL WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
