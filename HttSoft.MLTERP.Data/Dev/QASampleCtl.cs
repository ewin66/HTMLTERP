...
{
	/// <summary>
	/// 目的：Dev_QASample实体控制类
	/// 作者:chesj
	/// 创建日期:2014/3/31
	/// </summary>
	public sealed class QASampleCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public QASampleCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                QASample MasterEntity=(QASample)p_Entity;
                ...
                MasterField.Append("INSERT INTO Dev_QASample(");
                ...
                MasterField.Append("ID"+","); 
  				...
  				MasterField.Append("SampleTypeID"+","); 
  				MasterValue.Append(SysString.ToDBString(MasterEntity.SampleTypeID)+","); 
  				...
  				MasterField.Append("MVendorID"+","); 
  				MasterValue.Append(SysString.ToDBString(MasterEntity.MVendorID)+","); 
  				MasterField.Append("YVendorID"+","); 
  				MasterValue.Append(SysString.ToDBString(MasterEntity.YVendorID)+","); 
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Dev_QASample SET ");
                UpdateBuilder.Append(" ID="+SysString.ToDBString(MasterEntity.ID)+","); 
  				UpdateBuilder.Append(" SubmitFlag="+SysString.ToDBString(MasterEntity.SubmitFlag)+","); 
  				UpdateBuilder.Append(" DelFlag="+SysString.ToDBString(MasterEntity.DelFlag)+","); 
  				UpdateBuilder.Append(" FormNo="+SysString.ToDBString(MasterEntity.FormNo)+","); 
  				UpdateBuilder.Append(" SampleTypeID="+SysString.ToDBString(MasterEntity.SampleTypeID)+","); 
  				...
  				UpdateBuilder.Append(" MVendorID="+SysString.ToDBString(MasterEntity.MVendorID)+","); 
  				UpdateBuilder.Append(" YVendorID="+SysString.ToDBString(MasterEntity.YVendorID)+","); 
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Dev_QASample WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
