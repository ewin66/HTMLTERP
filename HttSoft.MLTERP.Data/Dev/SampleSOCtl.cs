...
{
	/// <summary>
	/// 目的：Dev_SampleSO实体控制类
	/// 作者:邱继中
	/// 创建日期:2014/6/9
	/// </summary>
	public sealed class SampleSOCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public SampleSOCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                SampleSO MasterEntity=(SampleSO)p_Entity;
                ...
                MasterField.Append("INSERT INTO Dev_SampleSO(");
                ...
                MasterField.Append("ID"+","); 
  				...
  				MasterField.Append("AppOPID"+","); 
  				MasterValue.Append(SysString.ToDBString(MasterEntity.AppOPID)+","); 
  				...
  				MasterField.Append("SaleGroup"+","); 
  				MasterValue.Append(SysString.ToDBString(MasterEntity.SaleGroup)+","); 
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Dev_SampleSO SET ");
                UpdateBuilder.Append(" ID="+SysString.ToDBString(MasterEntity.ID)+","); 
  				...
  				UpdateBuilder.Append(" AppOPID="+SysString.ToDBString(MasterEntity.AppOPID)+","); 
  				...
  				UpdateBuilder.Append(" SaleGroup="+SysString.ToDBString(MasterEntity.SaleGroup)+","); 
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Dev_SampleSO WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
