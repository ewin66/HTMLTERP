...
namespace HttSoft.MLTERP.DataCtl
{
	...
	/// 创建日期:2013-11-11
	/// </summary>
	public sealed class GBJCDtsCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public GBJCDtsCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                GBJCDts MasterEntity=(GBJCDts)p_Entity;
                ...
                MasterField.Append("INSERT INTO Dev_GBJCDts(");
                ...
                MasterField.Append("JYVendorID" + ",");
                MasterValue.Append(SysString.ToDBString(MasterEntity.JYVendorID) + ",");
                MasterField.Append("JYVendorName" + ")");
                MasterValue.Append(SysString.ToDBString(MasterEntity.JYVendorName) + ")"); 
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Dev_GBJCDts SET ");
                ...
                UpdateBuilder.Append(" JYVendorID=" + SysString.ToDBString(MasterEntity.JYVendorID) + ",");
                UpdateBuilder.Append(" JYVendorName=" + SysString.ToDBString(MasterEntity.JYVendorName)); 
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Dev_GBJCDts WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID)+" AND MainID="+SysString.ToDBString(MasterEntity.MainID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
