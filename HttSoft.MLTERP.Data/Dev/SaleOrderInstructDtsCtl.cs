...
{
	/// <summary>
	/// 目的：Sale_SaleOrderInstructDts实体控制类
	/// 作者:tanghao
	/// 创建日期:2015/5/22
	/// </summary>
	public sealed class SaleOrderInstructDtsCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public SaleOrderInstructDtsCtl()
		{
        ...
        /// 构造函数
        /// </summary>
        public SaleOrderInstructDtsCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                SaleOrderInstructDts MasterEntity=(SaleOrderInstructDts)p_Entity;
                ...
                MasterField.Append("INSERT INTO Sale_SaleOrderInstructDts(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Sale_SaleOrderInstructDts SET ");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Sale_SaleOrderInstructDts WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
