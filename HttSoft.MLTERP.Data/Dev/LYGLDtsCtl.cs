...
namespace HttSoft.MLTERP.DataCtl
{
	...
	/// 创建日期:2014/3/18
	/// </summary>
	public sealed class LYGLDtsCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public LYGLDtsCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                LYGLDts MasterEntity=(LYGLDts)p_Entity;
                ...
                MasterField.Append("INSERT INTO Dev_LYGLDts(");
                ...
                MasterField.Append("ID"+","); 
  				...
  				MasterField.Append("SaleQYSource"+","); 
  				MasterValue.Append(SysString.ToDBString(MasterEntity.SaleQYSource)+","); 
  				...
  				MasterField.Append("LYType"+")"); 
  				MasterValue.Append(SysString.ToDBString(MasterEntity.LYType)+")"); 
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Dev_LYGLDts SET ");
                UpdateBuilder.Append(" ID="+SysString.ToDBString(MasterEntity.ID)+","); 
  				...
  				UpdateBuilder.Append(" SaleQYSource="+SysString.ToDBString(MasterEntity.SaleQYSource)+","); 
  				...
  				UpdateBuilder.Append(" LYType="+SysString.ToDBString(MasterEntity.LYType)); 
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Dev_LYGLDts WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
