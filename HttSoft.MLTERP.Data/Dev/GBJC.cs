...
namespace HttSoft.MLTERP.Data
{
	...
	/// 创建日期:2013-11-14
	/// </summary>
	public sealed class GBJC : BaseEntity
	{
        ...
        /// 构造函数
        /// </summary>
        public GBJC(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        {
            string Sql="SELECT * FROM Dev_GBJC WHERE "+ "ID="+SysString.ToDBString(m_ID);
        ...
        protected override bool Select(string p_Sql)
        {
            ...
            if (MasterTable.Rows.Count>0)
            {
                ...
                m_TBFlag = SysConvert.ToInt32(MasterTable.Rows[0]["TBFlag"]);
