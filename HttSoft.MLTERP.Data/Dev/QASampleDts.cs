...
{
	/// <summary>
	/// 目的：Dev_QASampleDts实体类
	/// 作者:chesj
	/// 创建日期:2014/3/31
	/// </summary>
	public sealed class QASampleDts : BaseEntity
	{
        ...
        /// 构造函数
        /// </summary>
        public QASampleDts(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
		#region 属性
  		...
  		private DateTime m_SMDate = SystemConfiguration.DateTimeDefaultValue; 
        ...
        {
            string Sql="SELECT * FROM Dev_QASampleDts WHERE "+ "ID="+SysString.ToDBString(m_ID);
        ...
        protected override bool Select(string p_Sql)
        {
            ...
            if (MasterTable.Rows.Count>0)
            {
                ...
                m_ID=SysConvert.ToInt32(MasterTable.Rows[0]["ID"]); 
  				...
  				m_SMDate=SysConvert.ToDateTime(MasterTable.Rows[0]["SMDate"]); 
