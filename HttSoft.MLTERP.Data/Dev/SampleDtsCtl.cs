...
{
	/// <summary>
	/// 目的：Dev_SampleDts实体控制类
	/// 作者:qiuchao
	/// 创建日期:2015/5/28
	/// </summary>
	public sealed class SampleDtsCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public SampleDtsCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                SampleDts MasterEntity=(SampleDts)p_Entity;
                ...
                MasterField.Append("INSERT INTO Dev_SampleDts(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Dev_SampleDts SET ");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Dev_SampleDts WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
