...
namespace HttSoft.MLTERP.DataCtl
{
	...
	/// 创建日期:2013/12/19
	/// </summary>
	public sealed class GBJCLRCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public GBJCLRCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                GBJCLR MasterEntity=(GBJCLR)p_Entity;
                ...
                MasterField.Append("INSERT INTO Dev_GBJCLR(");
                ...
                MasterField.Append("ID"+","); 
  				...
  				MasterField.Append("DNo"+")"); 
  				MasterValue.Append(SysString.ToDBString(MasterEntity.DNo)+")"); 
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Dev_GBJCLR SET ");
                UpdateBuilder.Append(" ID="+SysString.ToDBString(MasterEntity.ID)+","); 
  				...
  				UpdateBuilder.Append(" DNo="+SysString.ToDBString(MasterEntity.DNo)); 
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Dev_GBJCLR WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
