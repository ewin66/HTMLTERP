...
namespace HttSoft.MLTERP.DataCtl
{
	...
	/// 创建日期:2013-11-14
	/// </summary>
	public sealed class GBJCCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public GBJCCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                GBJC MasterEntity=(GBJC)p_Entity;
                ...
                MasterField.Append("INSERT INTO Dev_GBJC(");
                ...
                MasterField.Append("TBFlag" + ",");
                MasterValue.Append(SysString.ToDBString(MasterEntity.TBFlag) + ","); 
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Dev_GBJC SET ");
                ...
                UpdateBuilder.Append(" TBFlag=" + SysString.ToDBString(MasterEntity.TBFlag) + ","); 
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Dev_GBJC WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
