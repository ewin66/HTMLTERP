...
{
	/// <summary>
	/// 目的：SMS_SParamset实体控制类
	/// 作者:章文强
	/// 创建日期:2012/7/11
	/// </summary>
	public sealed class SParamsetCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public SParamsetCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE SMS_SParamset SET ");
                UpdateBuilder.Append(" ID="+SysString.ToDBString(MasterEntity.ID)+","); 
  				...
  				{ 
  			 		UpdateBuilder.Append(" SetValueInt=null,");  
  				} 
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM SMS_SParamset WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
