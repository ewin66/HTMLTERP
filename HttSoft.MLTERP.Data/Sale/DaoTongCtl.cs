...
{
	/// <summary>
	/// 目的：Sale_DaoTong实体控制类
	/// 作者:曹小艮
	/// 创建日期:2012-3-30
	/// </summary>
	public sealed class DaoTongCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public DaoTongCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                DaoTong MasterEntity=(DaoTong)p_Entity;
                ...
                MasterField.Append("INSERT INTO Sale_DaoTong(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Sale_DaoTong SET ");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Sale_DaoTong WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
