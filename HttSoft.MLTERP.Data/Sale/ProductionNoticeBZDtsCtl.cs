...
{
	/// <summary>
	/// 目的：Sale_ProductionNoticeBZDts实体控制类
	/// 作者:章文强
	/// 创建日期:2014/10/15
	/// </summary>
	public sealed class ProductionNoticeBZDtsCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public ProductionNoticeBZDtsCtl()
		{
        ...
        /// 构造函数
        /// </summary>
        public ProductionNoticeBZDtsCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                ProductionNoticeBZDts MasterEntity=(ProductionNoticeBZDts)p_Entity;
                ...
                MasterField.Append("INSERT INTO Sale_ProductionNoticeBZDts(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Sale_ProductionNoticeBZDts SET ");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Sale_ProductionNoticeBZDts WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
