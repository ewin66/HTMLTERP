...
{
	/// <summary>
	/// 目的：Sale_VendorCompactDts实体控制类
	/// 作者:曹小艮
	/// 创建日期:2011-11-8
	/// </summary>
	public sealed class VendorCompactDtsCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public VendorCompactDtsCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                VendorCompactDts MasterEntity=(VendorCompactDts)p_Entity;
                ...
                MasterField.Append("INSERT INTO Sale_VendorCompactDts(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Sale_VendorCompactDts SET ");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Sale_VendorCompactDts WHERE "+ "MainID="+SysString.ToDBString(MasterEntity.MainID)+" AND Seq="+SysString.ToDBString(MasterEntity.Seq);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
