...
{
	/// <summary>
	/// 目的：Sale_SaleOrderTColorItem实体控制类
	/// 作者:章文强
	/// 创建日期:2013/9/25
	/// </summary>
	public sealed class SaleOrderTColorItemCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public SaleOrderTColorItemCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                SaleOrderTColorItem MasterEntity=(SaleOrderTColorItem)p_Entity;
                ...
                MasterField.Append("INSERT INTO Sale_SaleOrderTColorItem(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Sale_SaleOrderTColorItem SET ");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Sale_SaleOrderTColorItem WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
