...
{
	/// <summary>
	/// 目的：Sale_OrderProgress实体控制类
	/// 作者:章文强
	/// 创建日期:2012-5-31
	/// </summary>
	public sealed class OrderProgressCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public OrderProgressCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                OrderProgress MasterEntity=(OrderProgress)p_Entity;
                ...
                MasterField.Append("INSERT INTO Sale_OrderProgress(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Sale_OrderProgress SET ");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Sale_OrderProgress WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
