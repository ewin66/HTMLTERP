...
{
	/// <summary>
	/// 目的：Sale_ProductionNoticeRSDts实体类
	/// 作者:章文强
	/// 创建日期:2014/10/15
	/// </summary>
	public sealed class ProductionNoticeRSDts : BaseEntity
	{
	    private bool sqlTransFlag=false;
		private IDBTransAccess sqlTrans;
		
		public ProductionNoticeRSDts()
		{
        ...
        /// 构造函数
        /// </summary>
        public ProductionNoticeRSDts(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
		#region 属性
		public static readonly string TableName = "Sale_ProductionNoticeRSDts";
        ...
        {
            string Sql="SELECT * FROM Sale_ProductionNoticeRSDts WHERE "+ "ID="+SysString.ToDBString(m_ID);
