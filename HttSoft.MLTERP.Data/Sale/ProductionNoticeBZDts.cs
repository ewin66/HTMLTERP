...
{
	/// <summary>
	/// 目的：Sale_ProductionNoticeBZDts实体类
	/// 作者:章文强
	/// 创建日期:2014/10/15
	/// </summary>
	public sealed class ProductionNoticeBZDts : BaseEntity
	{
	    private bool sqlTransFlag=false;
		private IDBTransAccess sqlTrans;
		
		public ProductionNoticeBZDts()
		{
        ...
        /// 构造函数
        /// </summary>
        public ProductionNoticeBZDts(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
		#region 属性
		public static readonly string TableName = "Sale_ProductionNoticeBZDts";
        ...
        {
            string Sql="SELECT * FROM Sale_ProductionNoticeBZDts WHERE "+ "ID="+SysString.ToDBString(m_ID);
