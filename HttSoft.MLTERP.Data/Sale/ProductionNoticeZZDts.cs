...
{
	/// <summary>
	/// 目的：Sale_ProductionNoticeZZDts实体类
	/// 作者:章文强
	/// 创建日期:2014/10/15
	/// </summary>
	public sealed class ProductionNoticeZZDts : BaseEntity
	{
	    private bool sqlTransFlag=false;
		private IDBTransAccess sqlTrans;
		
		public ProductionNoticeZZDts()
		{
        ...
        /// 构造函数
        /// </summary>
        public ProductionNoticeZZDts(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
		#region 属性
		public static readonly string TableName = "Sale_ProductionNoticeZZDts";
        ...
        {
            string Sql="SELECT * FROM Sale_ProductionNoticeZZDts WHERE "+ "ID="+SysString.ToDBString(m_ID);
