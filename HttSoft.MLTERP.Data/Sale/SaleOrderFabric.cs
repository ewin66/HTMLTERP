...
{
	/// <summary>
	/// 目的：Sale_SaleOrderFabric实体类
	/// 作者:wangyq
	/// 创建日期:2014/10/14
	/// </summary>
	public sealed class SaleOrderFabric : BaseEntity
	{
	    private bool sqlTransFlag=false;
		private IDBTransAccess sqlTrans;
		
		public SaleOrderFabric()
		{
        ...
        /// 构造函数
        /// </summary>
        public SaleOrderFabric(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
		#region 属性
		public static readonly string TableName = "Sale_SaleOrderFabric";
        ...
        {
            string Sql="SELECT * FROM Sale_SaleOrderFabric WHERE "+ "ID="+SysString.ToDBString(m_ID);
