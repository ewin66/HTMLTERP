...
{
	/// <summary>
	/// 目的：Sale_FHFormDtsPack实体控制类
	/// 作者:陈加海
	/// 创建日期:2014/5/23
	/// </summary>
	public sealed class FHFormDtsPackCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public FHFormDtsPackCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                FHFormDtsPack MasterEntity=(FHFormDtsPack)p_Entity;
                ...
                MasterField.Append("INSERT INTO Sale_FHFormDtsPack(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Sale_FHFormDtsPack SET ");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Sale_FHFormDtsPack WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
