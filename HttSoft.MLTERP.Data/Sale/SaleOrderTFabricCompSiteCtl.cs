...
{
	/// <summary>
	/// 目的：Sale_SaleOrderTFabricCompSite实体控制类
	/// 作者:陈加海
	/// 创建日期:2014/5/21
	/// </summary>
	public sealed class SaleOrderTFabricCompSiteCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public SaleOrderTFabricCompSiteCtl()
		{
        ...
        /// 构造函数
        /// </summary>
        public SaleOrderTFabricCompSiteCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                SaleOrderTFabricCompSite MasterEntity=(SaleOrderTFabricCompSite)p_Entity;
                ...
                MasterField.Append("INSERT INTO Sale_SaleOrderTFabricCompSite(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Sale_SaleOrderTFabricCompSite SET ");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Sale_SaleOrderTFabricCompSite WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
