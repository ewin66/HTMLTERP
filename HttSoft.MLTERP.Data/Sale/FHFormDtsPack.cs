...
{
	/// <summary>
	/// 目的：Sale_FHFormDtsPack实体类
	/// 作者:陈加海
	/// 创建日期:2014/5/23
	/// </summary>
	public sealed class FHFormDtsPack : BaseEntity
	{
	    private bool sqlTransFlag=false;
		private IDBTransAccess sqlTrans;
		
		public FHFormDtsPack()
		{
        ...
        /// 构造函数
        /// </summary>
        public FHFormDtsPack(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        {
            string Sql="SELECT * FROM Sale_FHFormDtsPack WHERE "+ "ID="+SysString.ToDBString(m_ID);
