...
{
	/// <summary>
	/// 目的：Sale_ProductionNoticeHZLDts实体控制类
	/// 作者:章文强
	/// 创建日期:2014/10/15
	/// </summary>
	public sealed class ProductionNoticeHZLDtsCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public ProductionNoticeHZLDtsCtl()
		{
        ...
        /// 构造函数
        /// </summary>
        public ProductionNoticeHZLDtsCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                ProductionNoticeHZLDts MasterEntity=(ProductionNoticeHZLDts)p_Entity;
                ...
                MasterField.Append("INSERT INTO Sale_ProductionNoticeHZLDts(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Sale_ProductionNoticeHZLDts SET ");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Sale_ProductionNoticeHZLDts WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
