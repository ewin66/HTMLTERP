...
{
	/// <summary>
	/// 目的：Sale_AuditPriceDts实体控制类
	/// 作者:曹小艮
	/// 创建日期:2011-12-30
	/// </summary>
	public sealed class AuditPriceDtsCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public AuditPriceDtsCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Sale_AuditPriceDts SET ");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Sale_AuditPriceDts WHERE "+ "MainID="+SysString.ToDBString(MasterEntity.MainID)+" AND Seq="+SysString.ToDBString(MasterEntity.Seq);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
