...
{
	/// <summary>
	/// 目的：Sale_SaleOrderItem实体类
	/// 作者:章文强
	/// 创建日期:2013/11/20
	/// </summary>
	public sealed class SaleOrderItem : BaseEntity
	{
        ...
        /// 构造函数
        /// </summary>
        public SaleOrderItem(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
		#region 属性
		public static readonly string TableName = "Sale_SaleOrderItem";
        ...
        {
            string Sql="SELECT * FROM Sale_SaleOrderItem WHERE "+ "ID="+SysString.ToDBString(m_ID);
        ...
        protected override bool Select(string p_Sql)
        {
            ...
            if (MasterTable.Rows.Count>0)
            {
                ...
                m_ID=SysConvert.ToInt32(MasterTable.Rows[0]["ID"]); 
  				...
  				m_Per=SysConvert.ToDecimal(MasterTable.Rows[0]["Per"]); 
  				m_SH2=SysConvert.ToDecimal(MasterTable.Rows[0]["SH2"]); 
  				m_BuyType=SysConvert.ToInt32(MasterTable.Rows[0]["BuyType"]); 
  				m_SH3=SysConvert.ToDecimal(MasterTable.Rows[0]["SH3"]); 
