...
{
	/// <summary>
	/// 目的：Sale_SaleOrderTItem实体类
	/// 作者:章文强
	/// 创建日期:2013/9/11
	/// </summary>
	public sealed class SaleOrderTItem : BaseEntity
	{
	    private bool sqlTransFlag=false;
		private IDBTransAccess sqlTrans;
		
		public SaleOrderTItem()
		{
        ...
        /// 构造函数
        /// </summary>
        public SaleOrderTItem(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
		#region 属性
		public static readonly string TableName = "Sale_SaleOrderTItem";
        ...
        {
            string Sql="SELECT * FROM Sale_SaleOrderTItem WHERE "+ "ID="+SysString.ToDBString(m_ID);
