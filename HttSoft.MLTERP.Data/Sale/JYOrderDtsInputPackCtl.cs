...
{
	/// <summary>
	/// 目的：Sale_JYOrderDtsInputPack实体控制类
	/// 作者:章文强
	/// 创建日期:2014/12/18
	/// </summary>
	public sealed class JYOrderDtsInputPackCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public JYOrderDtsInputPackCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                JYOrderDtsInputPack MasterEntity=(JYOrderDtsInputPack)p_Entity;
                ...
                MasterField.Append("INSERT INTO Sale_JYOrderDtsInputPack(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Sale_JYOrderDtsInputPack SET ");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Sale_JYOrderDtsInputPack WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
