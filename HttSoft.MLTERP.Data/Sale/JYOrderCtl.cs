...
{
	/// <summary>
	/// 目的：Sale_JYOrder实体控制类
	/// 作者:章文强
	/// 创建日期:2014/10/30
	/// </summary>
	public sealed class JYOrderCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public JYOrderCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                JYOrder MasterEntity=(JYOrder)p_Entity;
                ...
                MasterField.Append("INSERT INTO Sale_JYOrder(");
                ...
                MasterField.Append("ID"+","); 
  				...
  				MasterField.Append("JYTypeID"+")"); 
  				MasterValue.Append(SysString.ToDBString(MasterEntity.JYTypeID)+")"); 
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Sale_JYOrder SET ");
                UpdateBuilder.Append(" ID="+SysString.ToDBString(MasterEntity.ID)+","); 
  				...
  				UpdateBuilder.Append(" JYTypeID="+SysString.ToDBString(MasterEntity.JYTypeID)); 
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Sale_JYOrder WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
