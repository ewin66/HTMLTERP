...
{
	/// <summary>
	/// 目的：Sale_SaleOrderTColorItem实体类
	/// 作者:章文强
	/// 创建日期:2013/9/25
	/// </summary>
	public sealed class SaleOrderTColorItem : BaseEntity
	{
	    private bool sqlTransFlag=false;
		private IDBTransAccess sqlTrans;
		
		public SaleOrderTColorItem()
		{
        ...
        /// 构造函数
        /// </summary>
        public SaleOrderTColorItem(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
		#region 属性
		public static readonly string TableName = "Sale_SaleOrderTColorItem";
        ...
        {
            string Sql="SELECT * FROM Sale_SaleOrderTColorItem WHERE "+ "ID="+SysString.ToDBString(m_ID);
