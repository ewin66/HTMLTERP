...
{
	/// <summary>
	/// 目的：Sale_JYOrderDts实体控制类
	/// 作者:章文强
	/// 创建日期:2014/12/17
	/// </summary>
	public sealed class JYOrderDtsCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public JYOrderDtsCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                JYOrderDts MasterEntity=(JYOrderDts)p_Entity;
                ...
                MasterField.Append("INSERT INTO Sale_JYOrderDts(");
                ...
                MasterField.Append("ID"+","); 
  				...
  				MasterField.Append("FHQty"+","); 
  				if(MasterEntity.FHQty!=0) 
  				{ 
  			 		MasterValue.Append(SysString.ToDBString(MasterEntity.FHQty)+","); 
  				} 
  				else 
  				{ 
  			 		MasterValue.Append("null,"); 
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Sale_JYOrderDts SET ");
                UpdateBuilder.Append(" ID="+SysString.ToDBString(MasterEntity.ID)+","); 
  				...
  				{ 
  			 		UpdateBuilder.Append(" Width=null,");  
  				} 
  				...
  				if(MasterEntity.FHQty!=0) 
  				{ 
  			 		UpdateBuilder.Append(" FHQty="+SysString.ToDBString(MasterEntity.FHQty)+","); 
  				} 
  				else 
  				{ 
  			 		UpdateBuilder.Append(" FHQty=null,");  
  				} 
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Sale_JYOrderDts WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
