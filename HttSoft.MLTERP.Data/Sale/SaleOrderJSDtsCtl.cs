...
{
	/// <summary>
	/// 目的：Sale_SaleOrderJSDts实体控制类
	/// 作者:ZHJH
	/// 创建日期:2014-04-22
	/// </summary>
	public sealed class SaleOrderJSDtsCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public SaleOrderJSDtsCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                SaleOrderJSDts MasterEntity=(SaleOrderJSDts)p_Entity;
                ...
                MasterField.Append("INSERT INTO Sale_SaleOrderJSDts(");
                ...
                MasterField.Append("ID"+","); 
  				...
  				MasterField.Append("FHDate"+","); 
  				if(MasterEntity.FHDate!=SystemConfiguration.DateTimeDefaultValue) 
  				{ 
  			 		MasterValue.Append(SysString.ToDBString(MasterEntity.FHDate.ToString("yyyy-MM-dd HH:mm:ss"))+","); 
  				} 
  				else 
  				{ 
  			 		MasterValue.Append("null,"); 
  				...
  				MasterField.Append("KPDate"+","); 
  				if(MasterEntity.KPDate!=SystemConfiguration.DateTimeDefaultValue) 
  				{ 
  			 		MasterValue.Append(SysString.ToDBString(MasterEntity.KPDate.ToString("yyyy-MM-dd HH:mm:ss"))+","); 
  				} 
  				else 
  				{ 
  			 		MasterValue.Append("null,"); 
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Sale_SaleOrderJSDts SET ");
                UpdateBuilder.Append(" ID="+SysString.ToDBString(MasterEntity.ID)+","); 
  				...
  				if(MasterEntity.FHDate!=SystemConfiguration.DateTimeDefaultValue) 
  				{ 
  			 		UpdateBuilder.Append(" FHDate="+SysString.ToDBString(MasterEntity.FHDate.ToString("yyyy-MM-dd HH:mm:ss"))+","); 
  				} 
  				else 
  				{ 
  			 		UpdateBuilder.Append(" FHDate=null,");  
  				} 
  
  				 
  				if(MasterEntity.KPDate!=SystemConfiguration.DateTimeDefaultValue) 
  				{ 
  			 		UpdateBuilder.Append(" KPDate="+SysString.ToDBString(MasterEntity.KPDate.ToString("yyyy-MM-dd HH:mm:ss"))+","); 
  				} 
  				else 
  				{ 
  			 		UpdateBuilder.Append(" KPDate=null,");  
  				} 
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Sale_SaleOrderJSDts WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
