...
{
	/// <summary>
	/// 目的：Sale_SaleOrderTFabricCompSite实体类
	/// 作者:陈加海
	/// 创建日期:2014/5/21
	/// </summary>
	public sealed class SaleOrderTFabricCompSite : BaseEntity
	{
	    private bool sqlTransFlag=false;
		private IDBTransAccess sqlTrans;
		
		public SaleOrderTFabricCompSite()
		{
        ...
        /// 构造函数
        /// </summary>
        public SaleOrderTFabricCompSite(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        {
            string Sql="SELECT * FROM Sale_SaleOrderTFabricCompSite WHERE "+ "ID="+SysString.ToDBString(m_ID);
