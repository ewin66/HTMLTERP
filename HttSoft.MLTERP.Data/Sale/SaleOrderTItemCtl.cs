...
{
	/// <summary>
	/// 目的：Sale_SaleOrderTItem实体控制类
	/// 作者:章文强
	/// 创建日期:2013/9/11
	/// </summary>
	public sealed class SaleOrderTItemCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public SaleOrderTItemCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                SaleOrderTItem MasterEntity=(SaleOrderTItem)p_Entity;
                ...
                MasterField.Append("INSERT INTO Sale_SaleOrderTItem(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Sale_SaleOrderTItem SET ");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Sale_SaleOrderTItem WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
