...
{
	/// <summary>
	/// 目的：Sale_JYOrderDtsInputPack实体类
	/// 作者:章文强
	/// 创建日期:2014/12/18
	/// </summary>
	public sealed class JYOrderDtsInputPack : BaseEntity
	{
	    private bool sqlTransFlag=false;
		private IDBTransAccess sqlTrans;
		
		public JYOrderDtsInputPack()
		{
        ...
        /// 构造函数
        /// </summary>
        public JYOrderDtsInputPack(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
		#region 属性
		public static readonly string TableName = "Sale_JYOrderDtsInputPack";
        ...
        {
            string Sql="SELECT * FROM Sale_JYOrderDtsInputPack WHERE "+ "ID="+SysString.ToDBString(m_ID);
