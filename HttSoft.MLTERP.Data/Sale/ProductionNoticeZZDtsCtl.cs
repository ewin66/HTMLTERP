...
{
	/// <summary>
	/// 目的：Sale_ProductionNoticeZZDts实体控制类
	/// 作者:章文强
	/// 创建日期:2014/10/15
	/// </summary>
	public sealed class ProductionNoticeZZDtsCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public ProductionNoticeZZDtsCtl()
		{
        ...
        /// 构造函数
        /// </summary>
        public ProductionNoticeZZDtsCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                ProductionNoticeZZDts MasterEntity=(ProductionNoticeZZDts)p_Entity;
                ...
                MasterField.Append("INSERT INTO Sale_ProductionNoticeZZDts(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Sale_ProductionNoticeZZDts SET ");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Sale_ProductionNoticeZZDts WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
