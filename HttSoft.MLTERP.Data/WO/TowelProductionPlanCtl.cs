...
{
	/// <summary>
	/// 目的：WO_TowelProductionPlan实体控制类
	/// 作者:zhp
	/// 创建日期:2016/9/18
	/// </summary>
	public sealed class TowelProductionPlanCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public TowelProductionPlanCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
