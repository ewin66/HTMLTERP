...
{
	/// <summary>
	/// 目的：WO_TestReport实体控制类
	/// 作者:tanghao
	/// 创建日期:2015/5/25
	/// </summary>
	public sealed class TestReportCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public TestReportCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                TestReport MasterEntity=(TestReport)p_Entity;
                ...
                MasterField.Append("INSERT INTO WO_TestReport(");
                ...
                MasterField.Append("ID"+","); 
  				...
  				MasterField.Append("TestOPID"+","); 
  				MasterValue.Append(SysString.ToDBString(MasterEntity.TestOPID)+","); 
  				MasterField.Append("ItemSource"+","); 
  				MasterValue.Append(SysString.ToDBString(MasterEntity.ItemSource)+","); 
  				MasterField.Append("SXShrinkageJX"+","); 
  				if(MasterEntity.SXShrinkageJX!=0) 
  				{ 
  			 		MasterValue.Append(SysString.ToDBString(MasterEntity.SXShrinkageJX)+","); 
  				} 
  				else 
  				{ 
  			 		MasterValue.Append("null,"); 
  				...
  				MasterField.Append("SXShrinkageWX"+","); 
  				if(MasterEntity.SXShrinkageWX!=0) 
  				{ 
  			 		MasterValue.Append(SysString.ToDBString(MasterEntity.SXShrinkageWX)+","); 
  				} 
  				else 
  				{ 
  			 		MasterValue.Append("null,"); 
  				...
  				MasterField.Append("YTShrinkageJX"+","); 
  				if(MasterEntity.YTShrinkageJX!=0) 
  				{ 
  			 		MasterValue.Append(SysString.ToDBString(MasterEntity.YTShrinkageJX)+","); 
  				} 
  				else 
  				{ 
  			 		MasterValue.Append("null,"); 
  				...
  				MasterField.Append("YTShrinkageWX"+","); 
  				if(MasterEntity.YTShrinkageWX!=0) 
  				{ 
  			 		MasterValue.Append(SysString.ToDBString(MasterEntity.YTShrinkageWX)+","); 
  				} 
  				else 
  				{ 
  			 		MasterValue.Append("null,"); 
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE WO_TestReport SET ");
                UpdateBuilder.Append(" ID="+SysString.ToDBString(MasterEntity.ID)+","); 
  				...
  				UpdateBuilder.Append(" TestOPID="+SysString.ToDBString(MasterEntity.TestOPID)+","); 
  				UpdateBuilder.Append(" ItemSource="+SysString.ToDBString(MasterEntity.ItemSource)+","); 
  				 
  				if(MasterEntity.SXShrinkageJX!=0) 
  				{ 
  			 		UpdateBuilder.Append(" SXShrinkageJX="+SysString.ToDBString(MasterEntity.SXShrinkageJX)+","); 
  				} 
  				else 
  				{ 
  			 		UpdateBuilder.Append(" SXShrinkageJX=null,");  
  				} 
  
  				 
  				if(MasterEntity.SXShrinkageWX!=0) 
  				{ 
  			 		UpdateBuilder.Append(" SXShrinkageWX="+SysString.ToDBString(MasterEntity.SXShrinkageWX)+","); 
  				} 
  				else 
  				{ 
  			 		UpdateBuilder.Append(" SXShrinkageWX=null,");  
  				} 
  
  				 
  				if(MasterEntity.YTShrinkageJX!=0) 
  				{ 
  			 		UpdateBuilder.Append(" YTShrinkageJX="+SysString.ToDBString(MasterEntity.YTShrinkageJX)+","); 
  				} 
  				else 
  				{ 
  			 		UpdateBuilder.Append(" YTShrinkageJX=null,");  
  				} 
  
  				 
  				if(MasterEntity.YTShrinkageWX!=0) 
  				{ 
  			 		UpdateBuilder.Append(" YTShrinkageWX="+SysString.ToDBString(MasterEntity.YTShrinkageWX)+","); 
  				} 
  				else 
  				{ 
  			 		UpdateBuilder.Append(" YTShrinkageWX=null,");  
  				} 
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM WO_TestReport WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
