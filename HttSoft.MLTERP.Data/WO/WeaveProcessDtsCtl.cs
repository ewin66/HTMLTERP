...
{
	/// <summary>
	/// 目的：WO_WeaveProcessDts实体控制类
	/// 作者:翟晓东
	/// 创建日期:2012/8/27
	/// </summary>
	public sealed class WeaveProcessDtsCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public WeaveProcessDtsCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                WeaveProcessDts MasterEntity=(WeaveProcessDts)p_Entity;
                ...
                MasterField.Append("INSERT INTO WO_WeaveProcessDts(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE WO_WeaveProcessDts SET ");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM WO_WeaveProcessDts WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
