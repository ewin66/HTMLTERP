...
{
	/// <summary>
	/// 目的：WO_FabricWHOutFormDtsPack实体类
	/// 作者:陈加海
	/// 创建日期:2014/5/4
	/// </summary>
	public sealed class FabricWHOutFormDtsPack : BaseEntity
	{
	    private bool sqlTransFlag=false;
		private IDBTransAccess sqlTrans;
		
		public FabricWHOutFormDtsPack()
		{
        ...
        /// 构造函数
        /// </summary>
        public FabricWHOutFormDtsPack(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        {
            string Sql="SELECT * FROM WO_FabricWHOutFormDtsPack WHERE "+ "ID="+SysString.ToDBString(m_ID);
