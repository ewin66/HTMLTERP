...
{
	/// <summary>
	/// 目的：WO_PrintingProcessDts实体类
	/// 作者:翟晓东
	/// 创建日期:2012/8/22
	/// </summary>
	public sealed class PrintingProcessDts : BaseEntity
	{
	    private bool sqlTransFlag=false;
		private IDBTransAccess sqlTrans;
		
		public PrintingProcessDts()
		{
        ...
        /// 构造函数
        /// </summary>
        public PrintingProcessDts(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
		#region 属性
		public static readonly string TableName = "WO_PrintingProcessDts";
        ...
        {
            string Sql="SELECT * FROM WO_PrintingProcessDts WHERE "+ "ID="+SysString.ToDBString(m_ID);
