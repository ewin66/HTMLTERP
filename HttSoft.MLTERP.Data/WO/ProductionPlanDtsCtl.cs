...
{
	/// <summary>
	/// 目的：WO_ProductionPlanDts实体控制类
	/// 作者:qiuchao
	/// 创建日期:2015/6/18
	/// </summary>
	public sealed class ProductionPlanDtsCtl : BaseControl
	{
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                ProductionPlanDts MasterEntity=(ProductionPlanDts)p_Entity;
                ...
                MasterField.Append("INSERT INTO WO_ProductionPlanDts(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE WO_ProductionPlanDts SET ");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM WO_ProductionPlanDts WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
