...
{
	/// <summary>
	/// 目的：WO_FabricWHOutFormDtsPack实体控制类
	/// 作者:陈加海
	/// 创建日期:2014/5/4
	/// </summary>
	public sealed class FabricWHOutFormDtsPackCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public FabricWHOutFormDtsPackCtl()
		{
        ...
        /// 构造函数
        /// </summary>
        public FabricWHOutFormDtsPackCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                FabricWHOutFormDtsPack MasterEntity=(FabricWHOutFormDtsPack)p_Entity;
                ...
                MasterField.Append("INSERT INTO WO_FabricWHOutFormDtsPack(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE WO_FabricWHOutFormDtsPack SET ");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM WO_FabricWHOutFormDtsPack WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
