...
{
	/// <summary>
	/// 目的：WO_FabricWHOutFormDts实体类
	/// 作者:陈加海
	/// 创建日期:2014/5/4
	/// </summary>
	public sealed class FabricWHOutFormDts : BaseEntity
	{
	    private bool sqlTransFlag=false;
		private IDBTransAccess sqlTrans;
		
		public FabricWHOutFormDts()
		{
        ...
        /// 构造函数
        /// </summary>
        public FabricWHOutFormDts(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        {
            string Sql="SELECT * FROM WO_FabricWHOutFormDts WHERE "+ "ID="+SysString.ToDBString(m_ID);
