...
{
	/// <summary>
	/// 目的：WO_TowelProduction实体控制类
	/// 作者:zhp
	/// 创建日期:2016/9/1
	/// </summary>
	public sealed class TowelProductionCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public TowelProductionCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE WO_TowelProduction SET ");
                UpdateBuilder.Append(" ID="+SysString.ToDBString(MasterEntity.ID)+","); 
  				...
  				UpdateBuilder.Append(" HeGe="+SysString.ToDBString(MasterEntity.HeGe)+","); 
  				...
  				UpdateBuilder.Append(" WOTypeID="+SysString.ToDBString(MasterEntity.WOTypeID)+","); 
  				...
  				{ 
  			 		UpdateBuilder.Append(" FAid=null,");  
  				} 
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM WO_TowelProduction WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
