...
{
	/// <summary>
	/// 目的：WO_DesignDts实体控制类
	/// 作者:曹小艮
	/// 创建日期:2011-11-17
	/// </summary>
	public sealed class DesignDtsCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public DesignDtsCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE WO_DesignDts SET ");
                UpdateBuilder.Append(" MainID="+SysString.ToDBString(MasterEntity.MainID)+","); 
  				...
  				if(MasterEntity.proportion!=0) 
  				{ 
  			 		UpdateBuilder.Append(" proportion="+SysString.ToDBString(MasterEntity.proportion)+","); 
  				} 
  				else 
  				{ 
  			 		UpdateBuilder.Append(" proportion=null,");  
  				} 
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM WO_DesignDts WHERE "+ "MainID="+SysString.ToDBString(MasterEntity.MainID)+" AND Seq="+SysString.ToDBString(MasterEntity.Seq);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
