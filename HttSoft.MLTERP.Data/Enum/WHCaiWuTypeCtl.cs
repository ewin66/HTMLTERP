...
{
	/// <summary>
	/// 目的：Enum_WHCaiWuType实体控制类
	/// 作者:潘杰俊
	/// 创建日期:2009-4-22
	/// </summary>
	public sealed class WHCaiWuTypeCtl : BaseControl
	{
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                WHCaiWuType MasterEntity=(WHCaiWuType)p_Entity;
                ...
                MasterField.Append("INSERT INTO Enum_WHCaiWuType(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Enum_WHCaiWuType SET ");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Enum_WHCaiWuType WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
