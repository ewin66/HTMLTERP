...
{
	/// <summary>
	/// 目的：Enum_Exceptional实体控制类
	/// 作者:潘杰俊
	/// 创建日期:2009-9-7
	/// </summary>
	public sealed class ExceptionalCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public ExceptionalCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                ...
                MasterField.Append("INSERT INTO Enum_Exceptional(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Enum_Exceptional SET ");
