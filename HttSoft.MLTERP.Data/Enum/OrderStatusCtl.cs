...
{
	/// <summary>
	/// 目的：Enum_OrderStatus实体控制类
	/// 作者:陈加海
	/// 创建日期:2012-4-19
	/// </summary>
	public sealed class OrderStatusCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public OrderStatusCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                OrderStatus MasterEntity=(OrderStatus)p_Entity;
                ...
                MasterField.Append("INSERT INTO Enum_OrderStatus(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Enum_OrderStatus SET ");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Enum_OrderStatus WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
