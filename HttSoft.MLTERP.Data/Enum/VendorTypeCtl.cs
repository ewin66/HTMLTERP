...
{
	/// <summary>
	/// 目的：Enum_VendorType实体控制类
	/// 作者:陈加海
	/// 创建日期:2009-4-2
	/// </summary>
	public sealed class VendorTypeCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public VendorTypeCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                ...
                MasterField.Append("INSERT INTO Enum_VendorType(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Enum_VendorType SET ");
