...
{
	/// <summary>
	/// 目的：Enum_UploadPicProp实体控制类
	/// 作者:陈加海
	/// 创建日期:2009-04-10
	/// </summary>
	public sealed class UploadPicPropCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public UploadPicPropCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                UploadPicProp MasterEntity=(UploadPicProp)p_Entity;
                ...
                MasterField.Append("INSERT INTO Enum_UploadPicProp(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Enum_UploadPicProp SET ");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Enum_UploadPicProp WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
