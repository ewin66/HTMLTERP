...
{
	/// <summary>
	/// 目的：Enum_BoxStatus实体类
	/// 作者:陈加海
	/// 创建日期:2012-5-7
	/// </summary>
	public sealed class BoxStatus : BaseEntity
	{
        ...
        /// 构造函数
        /// </summary>
        public BoxStatus(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        {
            string Sql="SELECT * FROM Enum_BoxStatus WHERE "+ "ID="+SysString.ToDBString(m_ID);
