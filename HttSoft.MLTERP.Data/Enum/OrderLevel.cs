...
{
	/// <summary>
	/// 目的：Enum_OrderLevel实体类
	/// 作者:陈加海
	/// 创建日期:2012-4-19
	/// </summary>
	public sealed class OrderLevel : BaseEntity
	{
        ...
        /// 构造函数
        /// </summary>
        public OrderLevel(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        {
            string Sql="SELECT * FROM Enum_OrderLevel WHERE "+ "ID="+SysString.ToDBString(m_ID);
