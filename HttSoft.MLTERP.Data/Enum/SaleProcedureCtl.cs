...
{
	/// <summary>
	/// 目的：Enum_SaleProcedure实体控制类
	/// 作者:chengtb
	/// 创建日期:2014-5-4
	/// </summary>
	public sealed class SaleProcedureCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public SaleProcedureCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                ...
                MasterField.Append("INSERT INTO Enum_SaleProcedure(");
                ...
                MasterField.Append("ID"+","); 
  				...
  				MasterField.Append("JGUseFlag"+","); 
  				MasterValue.Append(SysString.ToDBString(MasterEntity.JGUseFlag)+","); 
  				MasterField.Append("JGItemTypeID"+","); 
  				MasterValue.Append(SysString.ToDBString(MasterEntity.JGItemTypeID)+","); 
  				MasterField.Append("JGWHIDDefault"+","); 
  				MasterValue.Append(SysString.ToDBString(MasterEntity.JGWHIDDefault)+","); 
  				MasterField.Append("JGFormListID"+","); 
  				MasterValue.Append(SysString.ToDBString(MasterEntity.JGFormListID)+","); 
  				MasterField.Append("PackCheckFlag"+")"); 
  				MasterValue.Append(SysString.ToDBString(MasterEntity.PackCheckFlag)+")"); 
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Enum_SaleProcedure WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
