...
{
	/// <summary>
	/// 目的：Enum_OrderLevel实体控制类
	/// 作者:陈加海
	/// 创建日期:2012-4-19
	/// </summary>
	public sealed class OrderLevelCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public OrderLevelCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Enum_OrderLevel SET ");
