...
{
	/// <summary>
	/// 目的：Enum_RequestType实体控制类
	/// 作者:潘杰俊
	/// 创建日期:2009-10-21
	/// </summary>
	public sealed class RequestTypeCtl : BaseControl
	{
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                RequestType MasterEntity=(RequestType)p_Entity;
                ...
                MasterField.Append("INSERT INTO Enum_RequestType(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Enum_RequestType SET ");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Enum_RequestType WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
