...
{
	/// <summary>
	/// 目的：Enum_WHCalMethod实体控制类
	/// 作者:陈加海
	/// 创建日期:2009-4-2
	/// </summary>
	public sealed class WHCalMethodCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public WHCalMethodCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Enum_WHCalMethod SET ");
                UpdateBuilder.Append(" ID="+SysString.ToDBString(MasterEntity.ID)+","); 
  				...
  				UpdateBuilder.Append(" FieldName="+SysString.ToDBString(MasterEntity.FieldName)+","); 
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Enum_WHCalMethod WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
