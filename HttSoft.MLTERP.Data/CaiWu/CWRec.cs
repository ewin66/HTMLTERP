...
namespace HttSoft.MLTERP.Data
{
	...
	/// 创建日期:2011-11-3
	/// </summary>
	public sealed class CWRec : BaseEntity
	{
        ...
        /// 构造函数
        /// </summary>
        public CWRec(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        {
            string Sql="SELECT * FROM CaiWu_CWRec WHERE "+ "ID="+SysString.ToDBString(m_ID);
        ...
        protected override bool Select(string p_Sql)
        {
            ...
            if (MasterTable.Rows.Count>0)
            {
                ...
                m_ID=SysConvert.ToInt32(MasterTable.Rows[0]["ID"]); 
  				...
  				m_RecAmount=SysConvert.ToDecimal(MasterTable.Rows[0]["RecAmount"]); 
