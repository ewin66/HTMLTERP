...
namespace HttSoft.MLTERP.DataCtl
{
	...
	/// 创建日期:2011-11-3
	/// </summary>
	public sealed class CWPayCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public CWPayCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                CWPay MasterEntity=(CWPay)p_Entity;
                ...
                MasterField.Append("INSERT INTO CaiWu_CWPay(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE CaiWu_CWPay SET ");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM CaiWu_CWPay WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
