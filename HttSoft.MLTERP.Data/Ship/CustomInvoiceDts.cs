...
{
	/// <summary>
	/// 目的：Ship_CustomInvoiceDts实体类
	/// 作者:qiuchao
	/// 创建日期:2015/7/23
	/// </summary>
	public sealed class CustomInvoiceDts : BaseEntity
	{
	    private bool sqlTransFlag=false;
		private IDBTransAccess sqlTrans;
		
		public CustomInvoiceDts()
		{
        ...
        /// 构造函数
        /// </summary>
        public CustomInvoiceDts(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
		#region 属性
		public static readonly string TableName = "Ship_CustomInvoiceDts";
        ...
        {
            string Sql="SELECT * FROM Ship_CustomInvoiceDts WHERE "+ "MainID="+SysString.ToDBString(m_MainID)+" AND Seq="+SysString.ToDBString(m_Seq);
