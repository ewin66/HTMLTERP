...
{
	/// <summary>
	/// 目的：Finance_CheckOperationPayDts实体控制类
	/// 作者:章文强
	/// 创建日期:2012/7/30
	/// </summary>
	public sealed class CheckOperationPayDtsCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public CheckOperationPayDtsCtl()
		{
        ...
        /// 构造函数
        /// </summary>
        public CheckOperationPayDtsCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                CheckOperationPayDts MasterEntity=(CheckOperationPayDts)p_Entity;
                ...
                MasterField.Append("INSERT INTO Finance_CheckOperationPayDts(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Finance_CheckOperationPayDts SET ");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Finance_CheckOperationPayDts WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
