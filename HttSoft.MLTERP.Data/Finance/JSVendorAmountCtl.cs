...
{
	/// <summary>
	/// 目的：Finance_JSVendorAmount实体控制类
	/// 作者:章文强
	/// 创建日期:2012/9/13
	/// </summary>
	public sealed class JSVendorAmountCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public JSVendorAmountCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                JSVendorAmount MasterEntity=(JSVendorAmount)p_Entity;
                ...
                MasterField.Append("INSERT INTO Finance_JSVendorAmount(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Finance_JSVendorAmount SET ");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Finance_JSVendorAmount WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
