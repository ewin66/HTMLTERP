...
{
	/// <summary>
	/// 目的：Finance_InvoiceYOperationDts实体类
	/// 作者:章文强
	/// 创建日期:2013/8/2
	/// </summary>
	public sealed class InvoiceYOperationDts : BaseEntity
	{
	    private bool sqlTransFlag=false;
		private IDBTransAccess sqlTrans;
		
		public InvoiceYOperationDts()
		{
        ...
        /// 构造函数
        /// </summary>
        public InvoiceYOperationDts(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
		#region 属性
		public static readonly string TableName = "Finance_InvoiceYOperationDts";
  		...
  		private string m_DtsOrderNo = string.Empty ; 
  		public string DtsOrderNo 
  		{ 
  			get 
  			{ 
  				return m_DtsOrderNo ; 
        ...
        {
            string Sql="SELECT * FROM Finance_InvoiceYOperationDts WHERE "+ "ID="+SysString.ToDBString(m_ID);
        ...
        protected override bool Select(string p_Sql)
        {
            ...
            if (MasterTable.Rows.Count>0)
            {
                ...
                m_ID=SysConvert.ToInt32(MasterTable.Rows[0]["ID"]); 
  				...
  				m_DtsOrderNo=SysConvert.ToString(MasterTable.Rows[0]["DtsOrderNo"]); 
