...
{
	/// <summary>
	/// 目的：Finance_JSVendorAmount实体类
	/// 作者:章文强
	/// 创建日期:2012/9/13
	/// </summary>
	public sealed class JSVendorAmount : BaseEntity
	{
	    private bool sqlTransFlag=false;
		private IDBTransAccess sqlTrans;
		
		public JSVendorAmount()
		{
        ...
        /// 构造函数
        /// </summary>
        public JSVendorAmount(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
		#region 属性
		public static readonly string TableName = "Finance_JSVendorAmount";
        ...
        {
            string Sql="SELECT * FROM Finance_JSVendorAmount WHERE "+ "ID="+SysString.ToDBString(m_ID);
