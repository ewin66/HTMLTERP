...
{
	/// <summary>
	/// 目的：Finance_WHAmountCE实体类
	/// 作者:章文强
	/// 创建日期:2012/11/14
	/// </summary>
	public sealed class WHAmountCE : BaseEntity
	{
        ...
        /// 构造函数
        /// </summary>
        public WHAmountCE(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
		#region 属性
		public static readonly string TableName = "Finance_WHAmountCE";
        ...
        {
            string Sql="SELECT * FROM Finance_WHAmountCE WHERE "+ "ID="+SysString.ToDBString(m_ID);
