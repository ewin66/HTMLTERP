...
{
	/// <summary>
	/// 目的：Finance_Express实体控制类
	/// 作者:陈加海
	/// 创建日期:2012-4-17
	/// </summary>
	public sealed class ExpressCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public ExpressCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Finance_Express WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
