...
{
	/// <summary>
	/// 目的：Finance_CostRegister实体类
	/// 作者:陈加海
	/// 创建日期:2012-4-17
	/// </summary>
	public sealed class CostRegister : BaseEntity
	{
        ...
        /// 构造函数
        /// </summary>
        public CostRegister(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
		#region 属性
        public static string TableName = "Finance_CostRegister";
  		private int m_ID = 0; 
  		public int ID 
  		{ 
  			get 
        ...
        {
            string Sql="SELECT * FROM Finance_CostRegister WHERE "+ "ID="+SysString.ToDBString(m_ID);
