...
{
	/// <summary>
	/// 目的：Finance_WHAmountCE实体控制类
	/// 作者:章文强
	/// 创建日期:2012/11/14
	/// </summary>
	public sealed class WHAmountCECtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public WHAmountCECtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                WHAmountCE MasterEntity=(WHAmountCE)p_Entity;
                ...
                MasterField.Append("INSERT INTO Finance_WHAmountCE(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Finance_WHAmountCE SET ");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Finance_WHAmountCE WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
