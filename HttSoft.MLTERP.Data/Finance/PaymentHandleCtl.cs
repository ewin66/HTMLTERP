...
{
	/// <summary>
	/// 目的：Finance_PaymentHandle实体控制类
	/// 作者:XUSC
	/// 创建日期:2016/1/22
	/// </summary>
	public sealed class PaymentHandleCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public PaymentHandleCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                PaymentHandle MasterEntity=(PaymentHandle)p_Entity;
                ...
                MasterField.Append("INSERT INTO Finance_PaymentHandle(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Finance_PaymentHandle SET ");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Finance_PaymentHandle WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
