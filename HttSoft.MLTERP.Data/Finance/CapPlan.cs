...
{
	/// <summary>
	/// 目的：Finance_CapPlan实体类
	/// 作者:章文强
	/// 创建日期:2012/6/11
	/// </summary>
	public sealed class CapPlan : BaseEntity
	{
        ...
        /// 构造函数
        /// </summary>
        public CapPlan(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
		#region 属性
		public static readonly string TableName = "Finance_CapPlan";
  		...
  		private string m_PlanOPID = string.Empty ; 
  		public string PlanOPID 
  		{ 
  			get 
  			{ 
  				return m_PlanOPID ; 
  		...
  		private int m_CapPlanTypeID = 0; 
  		public int CapPlanTypeID 
  		{ 
  			get 
  			{ 
  				return m_CapPlanTypeID ; 
  			}  
  			set 
  			{ 
  				m_CapPlanTypeID = value ; 
  			}  
  		} 
        ...
        {
            string Sql="SELECT * FROM Finance_CapPlan WHERE "+ "ID="+SysString.ToDBString(m_ID);
        ...
        protected override bool Select(string p_Sql)
        {
            ...
            if (MasterTable.Rows.Count>0)
            {
                ...
                m_ID=SysConvert.ToInt32(MasterTable.Rows[0]["ID"]); 
  				...
  				m_PlanOPID=SysConvert.ToString(MasterTable.Rows[0]["PlanOPID"]); 
  				...
  				m_CapPlanTypeID=SysConvert.ToInt32(MasterTable.Rows[0]["CapPlanTypeID"]); 
