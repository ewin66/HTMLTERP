...
{
	/// <summary>
	/// 目的：WH_StorgeLockHis实体类
	/// 作者:陈加海
	/// 创建日期:2012-5-7
	/// </summary>
	public sealed class StorgeLockHis : BaseEntity
	{
	    private bool sqlTransFlag=false;
		private IDBTransAccess sqlTrans;
		
		public StorgeLockHis()
		{
        ...
        /// 构造函数
        /// </summary>
        public StorgeLockHis(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
		#region 属性
  		...
  		private string m_UnlockOPID = string.Empty ; 
  		public string UnlockOPID 
  		{ 
  			get 
  			{ 
  				return m_UnlockOPID ; 
  		...
  		private DateTime m_UnlockTime = SystemConfiguration.DateTimeDefaultValue; 
  		...
  		private string m_UnlockDesc = string.Empty ; 
        ...
        {
            string Sql="SELECT * FROM WH_StorgeLockHis WHERE "+ "ID="+SysString.ToDBString(m_ID);
        ...
        protected override bool Select(string p_Sql)
        {
            ...
            if (MasterTable.Rows.Count>0)
            {
                ...
                m_ID=SysConvert.ToInt32(MasterTable.Rows[0]["ID"]); 
  				...
  				m_LockQty=SysConvert.ToInt32(MasterTable.Rows[0]["LockQty"]); 
  				...
  				m_UnlockOPID=SysConvert.ToString(MasterTable.Rows[0]["UnlockOPID"]); 
  				m_UnlockTime=SysConvert.ToDateTime(MasterTable.Rows[0]["UnlockTime"]); 
  				m_UnlockDesc=SysConvert.ToString(MasterTable.Rows[0]["UnlockDesc"]); 
