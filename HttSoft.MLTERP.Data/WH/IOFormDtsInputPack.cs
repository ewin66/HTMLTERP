...
{
	/// <summary>
	/// 目的：WH_IOFormDtsInputPack实体类
	/// 作者:陈加海
	/// 创建日期:2014/5/23
	/// </summary>
	public sealed class IOFormDtsInputPack : BaseEntity
	{
	    private bool sqlTransFlag=false;
		private IDBTransAccess sqlTrans;
		
		public IOFormDtsInputPack()
		{
        ...
        /// 构造函数
        /// </summary>
        public IOFormDtsInputPack(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        {
            string Sql="SELECT * FROM WH_IOFormDtsInputPack WHERE "+ "ID="+SysString.ToDBString(m_ID);
