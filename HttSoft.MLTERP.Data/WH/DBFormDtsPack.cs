...
{
	/// <summary>
	/// 目的：WH_DBFormDtsPack实体类
	/// 作者:周富春
	/// 创建日期:2015/7/27
	/// </summary>
	public sealed class DBFormDtsPack : BaseEntity
	{
	    private bool sqlTransFlag=false;
		private IDBTransAccess sqlTrans;
		
		public DBFormDtsPack()
		{
        ...
        /// 构造函数
        /// </summary>
        public DBFormDtsPack(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
		#region 属性
		public static readonly string TableName = "WH_DBFormDtsPack";
        ...
        {
            string Sql="SELECT * FROM WH_DBFormDtsPack WHERE "+ "ID="+SysString.ToDBString(m_ID);
