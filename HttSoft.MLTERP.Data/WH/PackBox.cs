...
namespace HttSoft.MLTERP.Data
{
	...
	public sealed class PackBox : BaseEntity
	{
		...
		#region 属性
		public static readonly string TableName = "WH_PackBox";
  		...
  		private string m_ReHandle = string.Empty ; 
  		...
  		private string m_SplitColor = string.Empty ; 
  		...
  		private string m_MiddleDiff = string.Empty ; 
  		public string MiddleDiff 
  		{ 
  			get 
  			{ 
  				return m_MiddleDiff ; 
  		...
  		private string m_HeadTailDiff = string.Empty ; 
  		public string HeadTailDiff 
  		{ 
  			get 
  			{ 
  				return m_HeadTailDiff ; 
  			}  
  			set 
  			{ 
  				m_HeadTailDiff = value ; 
  			}  
  		} 
        ...
        protected override bool Select(string p_Sql)
        {
            ...
            if (MasterTable.Rows.Count>0)
            {
                ...
                m_ID=SysConvert.ToInt32(MasterTable.Rows[0]["ID"]); 
  				...
  				m_ReHandle=SysConvert.ToString(MasterTable.Rows[0]["ReHandle"]); 
  				m_SplitColor=SysConvert.ToString(MasterTable.Rows[0]["SplitColor"]); 
  				m_MiddleDiff=SysConvert.ToString(MasterTable.Rows[0]["MiddleDiff"]); 
  				m_HeadTailDiff=SysConvert.ToString(MasterTable.Rows[0]["HeadTailDiff"]); 
