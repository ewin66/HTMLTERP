...
namespace HttSoft.MLTERP.DataCtl
{
	...
	/// 创建日期:2012/12/11
	/// </summary>
	public sealed class PckISNCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public PckISNCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                PckISN MasterEntity=(PckISN)p_Entity;
                ...
                MasterField.Append("INSERT INTO WH_PckISN(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE WH_PckISN SET ");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM WH_PckISN WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
