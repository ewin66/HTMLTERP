...
{
	/// <summary>
	/// 目的：WH_DBFormDts实体控制类
	/// 作者:陈加海
	/// 创建日期:2014/7/21
	/// </summary>
	public sealed class DBFormDtsCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public DBFormDtsCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE WH_DBFormDts SET ");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM WH_DBFormDts WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
