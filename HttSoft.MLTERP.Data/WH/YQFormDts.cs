...
namespace HttSoft.MLTERP.Data
{
	...
	/// 创建日期:2013/6/22
	/// </summary>
	public sealed class YQFormDts : BaseEntity
	{
        ...
        /// 构造函数
        /// </summary>
        public YQFormDts(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
		#region 属性
		public static readonly string TableName = "WH_YQFormDts";
  		...
  		private int m_DLaodDtsID = 0; 
  		public int DLaodDtsID 
  		{ 
  			get 
  			{ 
  				return m_DLaodDtsID ; 
  		...
  		private string m_DLoadFormNo = string.Empty ; 
  		public string DLoadFormNo 
  		{ 
  			get 
  			{ 
  				return m_DLoadFormNo ; 
  			}  
  			set 
  			{ 
  				m_DLoadFormNo = value ; 
  		...
  		private int m_DLoadSubType = 0; 
  		public int DLoadSubType 
  		{ 
  			get 
  			{ 
  				return m_DLoadSubType ; 
  			}  
  			set 
  			{ 
  				m_DLoadSubType = value ; 
  			}  
  		} 
        ...
        {
            string Sql="SELECT * FROM WH_YQFormDts WHERE "+ "ID="+SysString.ToDBString(m_ID);
        ...
        protected override bool Select(string p_Sql)
        {
            ...
            if (MasterTable.Rows.Count>0)
            {
                ...
                m_ID=SysConvert.ToInt32(MasterTable.Rows[0]["ID"]); 
  				...
  				m_DLaodDtsID=SysConvert.ToInt32(MasterTable.Rows[0]["DLaodDtsID"]); 
  				m_DLoadFormNo=SysConvert.ToString(MasterTable.Rows[0]["DLoadFormNo"]); 
  				m_DLoadSubType=SysConvert.ToInt32(MasterTable.Rows[0]["DLoadSubType"]); 
                MasterTable.Dispose();
                return true;
            }
            else
