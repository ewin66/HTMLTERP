...
namespace HttSoft.MLTERP.DataCtl
{
	...
	/// 创建日期:2009-7-18
	/// </summary>
	public sealed class WHPicCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public WHPicCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                WHPic MasterEntity=(WHPic)p_Entity;
                ...
                MasterField.Append("INSERT INTO WH_WHPic(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE WH_WHPic SET ");
                ...
                UpdateBuilder.Append(" WHERE "+ "MainID="+SysString.ToDBString(MasterEntity.MainID)+" AND WHPicID="+SysString.ToDBString(MasterEntity.WHPicID));
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM WH_WHPic WHERE "+ "MainID="+SysString.ToDBString(MasterEntity.MainID)+" AND WHPicID="+SysString.ToDBString(MasterEntity.WHPicID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
