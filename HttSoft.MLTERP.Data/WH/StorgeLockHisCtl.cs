...
{
	/// <summary>
	/// 目的：WH_StorgeLockHis实体控制类
	/// 作者:陈加海
	/// 创建日期:2012-5-7
	/// </summary>
	public sealed class StorgeLockHisCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public StorgeLockHisCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                StorgeLockHis MasterEntity=(StorgeLockHis)p_Entity;
                ...
                MasterField.Append("INSERT INTO WH_StorgeLockHis(");
                ...
                MasterField.Append("ID"+","); 
  				...
  				MasterField.Append("UnlockOPID"+","); 
  				MasterValue.Append(SysString.ToDBString(MasterEntity.UnlockOPID)+","); 
  				MasterField.Append("UnlockTime"+","); 
  				if(MasterEntity.UnlockTime!=SystemConfiguration.DateTimeDefaultValue) 
  				{ 
  			 		MasterValue.Append(SysString.ToDBString(MasterEntity.UnlockTime.ToString("yyyy-MM-dd HH:mm:ss"))+","); 
  				} 
  				else 
  				{ 
  			 		MasterValue.Append("null,"); 
  				...
  				MasterField.Append("UnlockDesc"+","); 
  				MasterValue.Append(SysString.ToDBString(MasterEntity.UnlockDesc)+","); 
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE WH_StorgeLockHis SET ");
                UpdateBuilder.Append(" ID="+SysString.ToDBString(MasterEntity.ID)+","); 
  				...
  				UpdateBuilder.Append(" UnlockOPID="+SysString.ToDBString(MasterEntity.UnlockOPID)+","); 
  				 
  				if(MasterEntity.UnlockTime!=SystemConfiguration.DateTimeDefaultValue) 
  				{ 
  			 		UpdateBuilder.Append(" UnlockTime="+SysString.ToDBString(MasterEntity.UnlockTime.ToString("yyyy-MM-dd HH:mm:ss"))+","); 
  				} 
  				else 
  				{ 
  			 		UpdateBuilder.Append(" UnlockTime=null,");  
  				} 
  
  				UpdateBuilder.Append(" UnlockDesc="+SysString.ToDBString(MasterEntity.UnlockDesc)+","); 
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM WH_StorgeLockHis WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
