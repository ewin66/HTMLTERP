...
{
	/// <summary>
	/// 目的：WH_YarnTiaoPing实体控制类
	/// 作者:qiujz
	/// 创建日期:2016/1/4
	/// </summary>
	public sealed class YarnTiaoPingCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public YarnTiaoPingCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                YarnTiaoPing MasterEntity=(YarnTiaoPing)p_Entity;
                ...
                MasterField.Append("INSERT INTO WH_YarnTiaoPing(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE WH_YarnTiaoPing SET ");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM WH_YarnTiaoPing WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
