...
{
	/// <summary>
	/// 目的：WH_PackBoxKPDts实体控制类
	/// 作者:XUSC
	/// 创建日期:2016/1/6
	/// </summary>
	public sealed class PackBoxKPDtsCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public PackBoxKPDtsCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                PackBoxKPDts MasterEntity=(PackBoxKPDts)p_Entity;
                ...
                MasterField.Append("INSERT INTO WH_PackBoxKPDts(");
                ...
                MasterField.Append("ID"+","); 
  				...
  				MasterField.Append("SourceYard"+","); 
  				if(MasterEntity.SourceYard!=0) 
  				{ 
  			 		MasterValue.Append(SysString.ToDBString(MasterEntity.SourceYard)+","); 
  				} 
  				else 
  				{ 
  			 		MasterValue.Append("null,"); 
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE WH_PackBoxKPDts SET ");
                UpdateBuilder.Append(" ID="+SysString.ToDBString(MasterEntity.ID)+","); 
  				...
  				if(MasterEntity.SourceYard!=0) 
  				{ 
  			 		UpdateBuilder.Append(" SourceYard="+SysString.ToDBString(MasterEntity.SourceYard)+","); 
  				} 
  				else 
  				{ 
  			 		UpdateBuilder.Append(" SourceYard=null,");  
  				} 
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM WH_PackBoxKPDts WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
