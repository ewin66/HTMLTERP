...
{
	/// <summary>
	/// 目的：WH_IOFormDtsInputPack实体控制类
	/// 作者:陈加海
	/// 创建日期:2014/5/23
	/// </summary>
	public sealed class IOFormDtsInputPackCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public IOFormDtsInputPackCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
