...
{
	/// <summary>
	/// 目的：Buy_ItemBuyCapExDts实体控制类
	/// 作者:章文强
	/// 创建日期:2012/7/30
	/// </summary>
	public sealed class ItemBuyCapExDtsCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public ItemBuyCapExDtsCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                ItemBuyCapExDts MasterEntity=(ItemBuyCapExDts)p_Entity;
                ...
                MasterField.Append("INSERT INTO Buy_ItemBuyCapExDts(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Buy_ItemBuyCapExDts SET ");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Buy_ItemBuyCapExDts WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
