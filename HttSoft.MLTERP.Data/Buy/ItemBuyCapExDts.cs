...
{
	/// <summary>
	/// 目的：Buy_ItemBuyCapExDts实体类
	/// 作者:章文强
	/// 创建日期:2012/7/30
	/// </summary>
	public sealed class ItemBuyCapExDts : BaseEntity
	{
	    private bool sqlTransFlag=false;
		private IDBTransAccess sqlTrans;
		
		public ItemBuyCapExDts()
		{
        ...
        /// 构造函数
        /// </summary>
        public ItemBuyCapExDts(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
		#region 属性
		public static readonly string TableName = "Buy_ItemBuyCapExDts";
        ...
        {
            string Sql="SELECT * FROM Buy_ItemBuyCapExDts WHERE "+ "ID="+SysString.ToDBString(m_ID);
