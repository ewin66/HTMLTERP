...
{
	/// <summary>
	/// 目的：Buy_ItemBuyCapDts实体类
	/// 作者:章文强
	/// 创建日期:2012/7/30
	/// </summary>
	public sealed class ItemBuyCapDts : BaseEntity
	{
	    private bool sqlTransFlag=false;
		private IDBTransAccess sqlTrans;
		
		public ItemBuyCapDts()
		{
        ...
        /// 构造函数
        /// </summary>
        public ItemBuyCapDts(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
		#region 属性
		public static readonly string TableName = "Buy_ItemBuyCapDts";
        ...
        {
            string Sql="SELECT * FROM Buy_ItemBuyCapDts WHERE "+ "ID="+SysString.ToDBString(m_ID);
