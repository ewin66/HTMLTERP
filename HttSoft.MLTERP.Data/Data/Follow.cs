...
namespace HttSoft.MLTERP.Data
{
	...
	public sealed class Follow : BaseEntity
	{
        ...
        /// 构造函数
        /// </summary>
        public Follow(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        {
            string Sql="SELECT * FROM Data_Follow WHERE "+ "ID="+SysString.ToDBString(m_ID);
        ...
        protected override bool Select(string p_Sql)
        {
            ...
            if (MasterTable.Rows.Count>0)
            {
                ...
                m_ID=SysConvert.ToInt32(MasterTable.Rows[0]["ID"]); 
  				...
  				m_Des=SysConvert.ToString(MasterTable.Rows[0]["Des"]); 
