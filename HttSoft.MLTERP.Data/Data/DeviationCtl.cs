...
{
	/// <summary>
	/// 目的：Data_Deviation实体控制类
	/// 作者:潘杰俊
	/// 创建日期:2009-7-13
	/// </summary>
	public sealed class DeviationCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public DeviationCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Data_Deviation SET ");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Data_Deviation WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
