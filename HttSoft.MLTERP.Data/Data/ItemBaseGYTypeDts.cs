...
{
	/// <summary>
	/// 目的：Data_ItemBaseGYTypeDts实体类
	/// 作者:陈加海
	/// 创建日期:2014/6/20
	/// </summary>
	public sealed class ItemBaseGYTypeDts : BaseEntity
	{
	    private bool sqlTransFlag=false;
		private IDBTransAccess sqlTrans;
		
		public ItemBaseGYTypeDts()
		{
        ...
        /// 构造函数
        /// </summary>
        public ItemBaseGYTypeDts(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        {
            string Sql="SELECT * FROM Data_ItemBaseGYTypeDts WHERE "+ "ID="+SysString.ToDBString(m_ID);
