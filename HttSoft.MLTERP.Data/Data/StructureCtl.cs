...
{
	/// <summary>
	/// 目的：Data_Structure实体控制类
	/// 作者:章文强
	/// 创建日期:2014/6/4
	/// </summary>
	public sealed class StructureCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public StructureCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                Structure MasterEntity=(Structure)p_Entity;
                ...
                MasterField.Append("INSERT INTO Data_Structure(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Data_Structure SET ");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Data_Structure WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
