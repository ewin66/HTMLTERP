...
{
	/// <summary>
	/// 目的：Data_FVendorForm实体控制类
	/// 作者:章文强
	/// 创建日期:2014/6/9
	/// </summary>
	public sealed class FVendorFormCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public FVendorFormCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                FVendorForm MasterEntity=(FVendorForm)p_Entity;
                ...
                MasterField.Append("INSERT INTO Data_FVendorForm(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Data_FVendorForm SET ");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Data_FVendorForm WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
