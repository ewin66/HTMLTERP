...
{
	/// <summary>
	/// 目的：Data_AddressListDts实体控制类
	/// 作者:lirm
	/// 创建日期:2013-1-30
	/// </summary>
	public sealed class AddressListDtsCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public AddressListDtsCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                AddressListDts MasterEntity=(AddressListDts)p_Entity;
                ...
                MasterField.Append("INSERT INTO Data_AddressListDts(");
                ...
                MasterField.Append("ID"+","); 
  				...
  				MasterField.Append("MTel"+","); 
  				MasterValue.Append(SysString.ToDBString(MasterEntity.MTel)+",");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Data_AddressListDts SET ");
                UpdateBuilder.Append(" ID="+SysString.ToDBString(MasterEntity.ID)+","); 
  				...
  				UpdateBuilder.Append(" MTel="+SysString.ToDBString(MasterEntity.MTel)+",");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Data_AddressListDts WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
