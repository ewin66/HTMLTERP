...
{
	/// <summary>
	/// 目的：Data_ItemTypeForm实体控制类
	/// 作者:潘杰俊
	/// 创建日期:2009-4-9
	/// </summary>
	public sealed class ItemTypeFormCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public ItemTypeFormCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                ItemTypeForm MasterEntity=(ItemTypeForm)p_Entity;
                ...
                MasterField.Append("INSERT INTO Data_ItemTypeForm(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Data_ItemTypeForm SET ");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Data_ItemTypeForm WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
