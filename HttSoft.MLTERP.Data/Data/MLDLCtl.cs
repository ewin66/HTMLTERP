...
namespace HttSoft.MLTERP.DataCtl
{
	...
	/// 创建日期:2012-4-18
	/// </summary>
	public sealed class MLDLCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public MLDLCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                MLDL MasterEntity=(MLDL)p_Entity;
                ...
                MasterField.Append("INSERT INTO Data_MLDL(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Data_MLDL SET ");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Data_MLDL WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
