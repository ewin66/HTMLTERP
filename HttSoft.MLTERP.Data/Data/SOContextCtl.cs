...
{
	/// <summary>
	/// 目的：Data_SOContext实体控制类
	/// 作者:翟晓东
	/// 创建日期:2012/8/27
	/// </summary>
	public sealed class SOContextCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public SOContextCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                SOContext MasterEntity=(SOContext)p_Entity;
                ...
                MasterField.Append("INSERT INTO Data_SOContext(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Data_SOContext SET ");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Data_SOContext WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
