...
{
	/// <summary>
	/// 目的：Data_VDsignerFile实体类
	/// 作者:陈加海
	/// 创建日期:2012-4-19
	/// </summary>
	public sealed class VDsignerFile : BaseEntity
	{
        ...
        /// 构造函数
        /// </summary>
        public VDsignerFile(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        {
            string Sql="SELECT * FROM Data_VDsignerFile WHERE "+ "ID="+SysString.ToDBString(m_ID);
