...
{
	/// <summary>
	/// 目的：Data_Structure实体类
	/// 作者:章文强
	/// 创建日期:2014/6/4
	/// </summary>
	public sealed class Structure : BaseEntity
	{
		...
		#region 属性
		public static readonly string TableName = "Data_Structure";
        ...
        {
            string Sql="SELECT * FROM Data_Structure WHERE "+ "ID="+SysString.ToDBString(m_ID);
