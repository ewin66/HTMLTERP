...
{
	/// <summary>
	/// 目的：Data_SOContext实体类
	/// 作者:翟晓东
	/// 创建日期:2012/8/27
	/// </summary>
	public sealed class SOContext : BaseEntity
	{
        ...
        /// 构造函数
        /// </summary>
        public SOContext(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
		#region 属性
		public static readonly string TableName = "Data_SOContext";
        ...
        {
            string Sql="SELECT * FROM Data_SOContext WHERE "+ "ID="+SysString.ToDBString(m_ID);
