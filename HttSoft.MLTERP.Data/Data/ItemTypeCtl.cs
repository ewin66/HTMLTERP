...
{
	/// <summary>
	/// 目的：Enum_ItemType实体控制类
	/// 作者:LookSun
	/// 创建日期:2009-4-1
	/// </summary>
	public sealed class ItemTypeCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public ItemTypeCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                HttSoft.MLTERP.Data.ItemType MasterEntity = (HttSoft.MLTERP.Data.ItemType)p_Entity;
                ...
                MasterField.Append("INSERT INTO Enum_ItemType(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Enum_ItemType SET ");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Enum_ItemType WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
