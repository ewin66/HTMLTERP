...
namespace HttSoft.MLTERP.DataCtl
{
	...
	/// 创建日期:2014-4-17
	/// </summary>
	public sealed class FNORelCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public FNORelCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                FNORel MasterEntity=(FNORel)p_Entity;
                ...
                MasterField.Append("INSERT INTO Data_FNORel(");
                ...
                MasterField.Append("ID"+","); 
  				...
  				MasterField.Append("SelfEditFlag"+","); 
  				MasterValue.Append(SysString.ToDBString(MasterEntity.SelfEditFlag)+","); 
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Data_FNORel SET ");
                UpdateBuilder.Append(" ID="+SysString.ToDBString(MasterEntity.ID)+","); 
  				...
  				UpdateBuilder.Append(" SelfEditFlag="+SysString.ToDBString(MasterEntity.SelfEditFlag)+","); 
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Data_FNORel WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
