...
{
	/// <summary>
	/// 目的：Data_ItemBaseCheckItem实体类
	/// 作者:陈加海
	/// 创建日期:2014/6/20
	/// </summary>
	public sealed class ItemBaseCheckItem : BaseEntity
	{
	    private bool sqlTransFlag=false;
		private IDBTransAccess sqlTrans;
		
		public ItemBaseCheckItem()
		{
        ...
        /// 构造函数
        /// </summary>
        public ItemBaseCheckItem(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        {
            string Sql="SELECT * FROM Data_ItemBaseCheckItem WHERE "+ "ID="+SysString.ToDBString(m_ID);
