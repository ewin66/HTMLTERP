...
namespace HttSoft.MLTERP.DataCtl
{
	...
	/// 创建日期:2012-4-18
	/// </summary>
	public sealed class MLLBCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public MLLBCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                MLLB MasterEntity=(MLLB)p_Entity;
                ...
                MasterField.Append("INSERT INTO Data_MLLB(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Data_MLLB SET ");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Data_MLLB WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
