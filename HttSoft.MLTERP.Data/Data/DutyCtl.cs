...
namespace HttSoft.MLTERP.DataCtl
{
	...
	/// 创建日期:2011-11-7
	/// </summary>
	public sealed class DutyCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public DutyCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                ...
                MasterField.Append("INSERT INTO Data_Duty(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Data_Duty SET ");
