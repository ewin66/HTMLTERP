...
{
	/// <summary>
	/// 目的：Data_WinListFillDateType实体控制类
	/// 作者:陈加海
	/// 创建日期:2012/5/22
	/// </summary>
	public sealed class WinListFillDateTypeCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public WinListFillDateTypeCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                WinListFillDateType MasterEntity=(WinListFillDateType)p_Entity;
                ...
                MasterField.Append("INSERT INTO Data_WinListFillDateType(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Data_WinListFillDateType SET ");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Data_WinListFillDateType WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
