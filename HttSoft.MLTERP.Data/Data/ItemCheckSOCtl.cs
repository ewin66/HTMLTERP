...
{
	/// <summary>
	/// 目的：Data_ItemCheckSO实体控制类
	/// 作者:陈加海
	/// 创建日期:2014/6/20
	/// </summary>
	public sealed class ItemCheckSOCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public ItemCheckSOCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                ItemCheckSO MasterEntity=(ItemCheckSO)p_Entity;
                ...
                MasterField.Append("INSERT INTO Data_ItemCheckSO(");
                ...
                MasterField.Append("ID"+","); 
  				...
  				MasterField.Append("CheckReason"+","); 
  				MasterValue.Append(SysString.ToDBString(MasterEntity.CheckReason)+","); 
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Data_ItemCheckSO SET ");
                UpdateBuilder.Append(" ID="+SysString.ToDBString(MasterEntity.ID)+","); 
  				...
  				UpdateBuilder.Append(" CheckReason="+SysString.ToDBString(MasterEntity.CheckReason)+","); 
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Data_ItemCheckSO WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
