...
namespace HttSoft.MLTERP.DataCtl
{
	...
	/// 创建日期:2014/6/4
	/// </summary>
	public sealed class FOPDepCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public FOPDepCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                FOPDep MasterEntity=(FOPDep)p_Entity;
                ...
                MasterField.Append("INSERT INTO Data_FOPDep(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Data_FOPDep SET ");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Data_FOPDep WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
