...
{
	/// <summary>
	/// 目的：Dev_ColorCard实体控制类
	/// 作者:章文强
	/// 创建日期:2014/12/2
	/// </summary>
	public sealed class ColorCardCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public ColorCardCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                ColorCard MasterEntity=(ColorCard)p_Entity;
                ...
                MasterField.Append("INSERT INTO Dev_ColorCard(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Dev_ColorCard SET ");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Dev_ColorCard WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
