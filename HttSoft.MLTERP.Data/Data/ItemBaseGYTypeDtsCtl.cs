...
{
	/// <summary>
	/// 目的：Data_ItemBaseGYTypeDts实体控制类
	/// 作者:陈加海
	/// 创建日期:2014/6/20
	/// </summary>
	public sealed class ItemBaseGYTypeDtsCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public ItemBaseGYTypeDtsCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                ItemBaseGYTypeDts MasterEntity=(ItemBaseGYTypeDts)p_Entity;
                ...
                MasterField.Append("INSERT INTO Data_ItemBaseGYTypeDts(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Data_ItemBaseGYTypeDts SET ");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Data_ItemBaseGYTypeDts WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
