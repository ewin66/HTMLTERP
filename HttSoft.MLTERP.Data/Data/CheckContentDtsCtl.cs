...
{
	/// <summary>
	/// 目的：Data_CheckContentDts实体控制类
	/// 作者:潘杰俊
	/// 创建日期:2009-7-10
	/// </summary>
	public sealed class CheckContentDtsCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public CheckContentDtsCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                CheckContentDts MasterEntity=(CheckContentDts)p_Entity;
                ...
                MasterField.Append("INSERT INTO Data_CheckContentDts(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Data_CheckContentDts SET ");
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Data_CheckContentDts WHERE "+ "MainID="+SysString.ToDBString(MasterEntity.MainID)+" AND Seq="+SysString.ToDBString(MasterEntity.Seq);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
