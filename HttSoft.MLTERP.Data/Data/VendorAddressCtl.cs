...
{
	/// <summary>
	/// 目的：Data_VendorAddress实体控制类
	/// 作者:周富春
	/// 创建日期:2011/11/29
	/// </summary>
	public sealed class VendorAddressCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public VendorAddressCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                VendorAddress MasterEntity=(VendorAddress)p_Entity;
                ...
                MasterField.Append("INSERT INTO Data_VendorAddress(");
                ...
                MasterField.Append("MainID"+","); 
  				...
  				MasterField.Append("Attn"+")"); 
  				MasterValue.Append(SysString.ToDBString(MasterEntity.Attn)+")"); 
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Data_VendorAddress SET ");
                UpdateBuilder.Append(" MainID="+SysString.ToDBString(MasterEntity.MainID)+","); 
  				...
  				UpdateBuilder.Append(" Attn="+SysString.ToDBString(MasterEntity.Attn)); 
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Data_VendorAddress WHERE "+ "MainID="+SysString.ToDBString(MasterEntity.MainID)+" AND Seq="+SysString.ToDBString(MasterEntity.Seq);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
