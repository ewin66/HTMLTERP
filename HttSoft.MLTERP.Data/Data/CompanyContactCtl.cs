...
{
	/// <summary>
	/// 目的：Data_CompanyContact实体控制类
	/// 作者:潘杰俊
	/// 创建日期:2009-4-16
	/// </summary>
	public sealed class CompanyContactCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public CompanyContactCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Data_CompanyContact SET ");
