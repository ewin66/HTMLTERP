...
{
	/// <summary>
	/// 目的：Att_ProductCheck实体控制类
	/// 作者:刘德苏
	/// 创建日期:2012/5/8
	/// </summary>
	public sealed class ProductCheckCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public ProductCheckCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                ProductCheck MasterEntity=(ProductCheck)p_Entity;
                ...
                MasterField.Append("INSERT INTO Att_ProductCheck(");
                ...
                MasterField.Append("ID"+","); 
  				...
  				MasterField.Append("CheOPID"+","); 
  				MasterValue.Append(SysString.ToDBString(MasterEntity.CheOPID)+","); 
  				...
  				MasterField.Append("WHRelFlag"+","); 
  				MasterValue.Append(SysString.ToDBString(MasterEntity.WHRelFlag)+","); 
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Att_ProductCheck SET ");
                UpdateBuilder.Append(" ID="+SysString.ToDBString(MasterEntity.ID)+","); 
  				...
  				UpdateBuilder.Append(" CheOPID="+SysString.ToDBString(MasterEntity.CheOPID)+","); 
  				UpdateBuilder.Append(" BuyFormNo="+SysString.ToDBString(MasterEntity.BuyFormNo)+","); 
  				UpdateBuilder.Append(" VendorID="+SysString.ToDBString(MasterEntity.VendorID)+","); 
  				UpdateBuilder.Append(" Remark="+SysString.ToDBString(MasterEntity.Remark)+","); 
  				UpdateBuilder.Append(" WHRelFlag="+SysString.ToDBString(MasterEntity.WHRelFlag)+","); 
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Att_ProductCheck WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
