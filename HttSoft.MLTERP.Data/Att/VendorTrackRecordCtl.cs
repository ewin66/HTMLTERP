...
{
	/// <summary>
	/// 目的：Att_VendorTrackRecord实体控制类
	/// 作者:陈加海
	/// 创建日期:2014/7/16
	/// </summary>
	public sealed class VendorTrackRecordCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public VendorTrackRecordCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                VendorTrackRecord MasterEntity=(VendorTrackRecord)p_Entity;
                ...
                MasterField.Append("INSERT INTO Att_VendorTrackRecord(");
                ...
                MasterField.Append("ID"+","); 
  				...
  				MasterField.Append("TrackType"+","); 
  				MasterValue.Append(SysString.ToDBString(MasterEntity.TrackType)+","); 
  				MasterField.Append("TrackTitle"+","); 
  				MasterValue.Append(SysString.ToDBString(MasterEntity.TrackTitle)+","); 
  				MasterField.Append("TrackContext"+","); 
  				MasterValue.Append(SysString.ToDBString(MasterEntity.TrackContext)+","); 
  				MasterField.Append("TrackContextRtf"+","); 
  				MasterValue.Append(SysString.ToDBString(MasterEntity.TrackContextRtf)+","); 
  				MasterField.Append("TrackFlag"+","); 
  				MasterValue.Append(SysString.ToDBString(MasterEntity.TrackFlag)+","); 
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Att_VendorTrackRecord SET ");
                UpdateBuilder.Append(" ID="+SysString.ToDBString(MasterEntity.ID)+","); 
  				...
  				UpdateBuilder.Append(" TrackType="+SysString.ToDBString(MasterEntity.TrackType)+","); 
  				UpdateBuilder.Append(" TrackTitle="+SysString.ToDBString(MasterEntity.TrackTitle)+","); 
  				UpdateBuilder.Append(" TrackContext="+SysString.ToDBString(MasterEntity.TrackContext)+","); 
  				UpdateBuilder.Append(" TrackContextRtf="+SysString.ToDBString(MasterEntity.TrackContextRtf)+","); 
  				UpdateBuilder.Append(" TrackFlag="+SysString.ToDBString(MasterEntity.TrackFlag)+","); 
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Att_VendorTrackRecord WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
