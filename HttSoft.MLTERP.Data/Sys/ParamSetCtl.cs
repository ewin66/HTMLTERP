...
{
	/// <summary>
	/// 目的：Sys_ParamSet实体控制类
	/// 作者:刘德苏
	/// 创建日期:2012/4/17
	/// </summary>
	public sealed class ParamSetCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public ParamSetCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                ParamSet MasterEntity=(ParamSet)p_Entity;
                ...
                MasterField.Append("INSERT INTO Sys_ParamSet(");
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Sys_ParamSet SET ");
                UpdateBuilder.Append(" ID="+SysString.ToDBString(MasterEntity.ID)+","); 
  				...
  				UpdateBuilder.Append(" SetValueStr="+SysString.ToDBString(MasterEntity.SetValueStr)+",");

                UpdateBuilder.Append(" SetValueInt=" + SysString.ToDBString(MasterEntity.SetValueInt) + ","); 
  				
  				 
  				if(MasterEntity.SetValueDt!=SystemConfiguration.DateTimeDefaultValue) 
  				{ 
  			 		UpdateBuilder.Append(" SetValueDt="+SysString.ToDBString(MasterEntity.SetValueDt.ToString("yyyy-MM-dd HH:mm:ss"))+","); 
  				} 
  				else 
  				{ 
  			 		UpdateBuilder.Append(" SetValueDt=null,");  
  				} 
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Sys_ParamSet WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
