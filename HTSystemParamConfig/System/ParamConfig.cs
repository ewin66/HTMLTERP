...
namespace HttSoft.HTERP.Sys
{
	...
	public sealed class ParamConfig
	{
        ...
        private static string m_SelfVendorID = "HTERP";//登录ID
        private static int m_CompanyType = 0;       //公司别
        private static string m_LoginCompanyName = "";//登录公司编码
        /// <summary>
        /// 仓库开启库别权限校验
        /// </summary>
        ...
        /// <summary>
        /// 系统客户绑定显示类型(默认只显示客户简称)
        /// </summary>
        public static string BindVendorDisplayField = "VendorAttn"; 
        ...
        /// <summary>
        /// 登陆公司编码（在Enum_CompanyType表中的Code字段中配置）
        /// </summary>
        public static string LoginCompanyName
        {
            get
            {
                return m_LoginCompanyName;
            }
            set
            {
                m_LoginCompanyName = value;
            }
        }
        /// <summary>
        /// Query Day Number
