...
{
	/// <summary>
	/// 目的：Data_ReportFileModel实体控制类
	/// 作者:陈加海
	/// 创建日期:2011-11-9
	/// </summary>
	public sealed class ReportFileModelCtl : BaseControl
	{
        ...
        /// 构造函数
        /// </summary>
        public ReportFileModelCtl(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        public override int AddNew(BaseEntity p_Entity)
        {
            try
            {
                ReportFileModel MasterEntity=(ReportFileModel)p_Entity;
                ...
                MasterField.Append("INSERT INTO Data_ReportFileModel(");
                ...
                MasterField.Append("ID"+","); 
  				...
  				MasterField.Append("MFlag"+","); 
  				MasterValue.Append(SysString.ToDBString(MasterEntity.MFlag)+","); 
        ...
        public override int Update(BaseEntity p_Entity)
        {
            try
            {
                ...
                UpdateBuilder.Append("UPDATE Data_ReportFileModel SET ");
                UpdateBuilder.Append(" ID="+SysString.ToDBString(MasterEntity.ID)+","); 
  				...
  				UpdateBuilder.Append(" MFlag="+SysString.ToDBString(MasterEntity.MFlag)+","); 
        ...
        public override int Delete(BaseEntity p_Entity)
        {
            try
            {
                ...
                //删除主表数据
                string Sql="";
                Sql="DELETE FROM Data_ReportFileModel WHERE "+ "ID="+SysString.ToDBString(MasterEntity.ID);
                //执行
				int AffectedRows=0;
				if(!this.sqlTransFlag)
				{
