...
{
	/// <summary>
	/// 目的：Chk_CheckOrderDts实体业务规则类
	/// 作者:周富春
	/// 创建日期:2015/11/5
	/// </summary>
	public class CheckOrderDtsRule
	{
	    /// <summary>
        /// 构造函数
        /// </summary>
		public CheckOrderDtsRule()
		{
		}
		...
		{
			CheckOrderDts entity=(CheckOrderDts)p_BE;
		}	
        ...
        public DataTable RShow(string p_condition, string p_FieldName)
        {
            try
            {
                ...
                string sql = "SELECT " + p_FieldName + " FROM Chk_CheckOrderDts WHERE 1=1";
                sql += p_condition;
		...
		public void RAdd(BaseEntity p_BE,IDBTransAccess sqlTrans)
		{
			try
			{
				...
				CheckOrderDts entity=(CheckOrderDts)p_BE;				
				CheckOrderDtsCtl control=new CheckOrderDtsCtl(sqlTrans);
                entity.ID = (int)EntityIDTable.GetID((long)SysEntity.Chk_CheckOrderDts, sqlTrans);
