...
namespace MLTERP
{
    ...
    /// 采购图形分析报表
    /// </summary>
    public partial class frmItemBuyGraphRpt : frmAPBaseUIRpt
    {
        public frmItemBuyGraphRpt()
        {
            InitializeComponent();
        }
        ...
        private DataTable GetDataSource(int year)
        {
            ...
            sql += "  (SELECT Qty,DATEPART (M,MakeDate ) Mon,MakeDate ";
            sql += "   FROM UV1_Buy_ItemBuyFormDts WHERE SubmitFlag=1 AND MakeDate ";
            ...
            sql += " AND MLType=" + SysString.ToDBString(this.FormListAID);
        ...
        private void CreateGraph(ZedGraphControl zgc, DataTable dtS)
        {
            ...
            myPane.Title.Text = drpCheckYear.Text + "年 月采购量柱状图  (单位：吨)";
            myPane.XAxis.Title.Text = "月份";
            myPane.YAxis.Title.Text = "采购量";
            ...
            BarItem myCurve = myPane.AddBar("采购量", list, Color.Blue);//使用哪一种图类
        ...
        private void CreateGraphCur(ZedGraphControl zgc, DataTable[] dtS, int[] p_YI)
        {
            ...
            //myPane.xAxisList.Clear();
            // Set the titles and axis labels
            myPane.Title.Text = (SysConvert.ToInt32(drpCheckYear.Text) - SysConvert.ToInt32(drpCheckYearNum.Text)).ToString() + "--" + drpCheckYear.Text + "年 月采购量对比图  (单位：吨)";
            myPane.XAxis.Title.Text = "月份";
            myPane.YAxis.Title.Text = "采购量";
        ...
        private void CreateGraphSOTypeSource(ZedGraphControl zgc, DataTable dtS)
        {
            ...
            //myPane.xAxisList.Clear();
            // Set the titles and axis labels
            myPane.Title.Text = drpCheckYear.Text + "年 采购组别饼图  (单位：吨)";
            //myPane.XAxis.Title.Text = "月份";
            myPane.YAxis.Title.Text = "采购量";
        ...
        private void CreateGraphGoodsTypeSource(ZedGraphControl zgc, DataTable dtS)
        {
            ...
            //myPane.xAxisList.Clear();
            // Set the titles and axis labels
            myPane.Title.Text = drpCheckYear.Text + "年 采购类型饼图  (单位：吨)";
            //myPane.XAxis.Title.Text = "月份";
            myPane.YAxis.Title.Text = "采购量";
        ...
        private void CreateChart5()
        {
            try
            {
                ...
                {
                    //设置Titles
                    Chart5.Titles["Title1"].Text = drpCheckYear.Text.Trim() + "每月采购量图形报表";
                    //设置X轴
                    ...
                    //设置Y轴
                    Chart5.ChartAreas["Chart Area 1"].AxisY.Title = "采购量";
        ...
        private void CreateChart8()
        {
            try
            {
                ...
                {
                    //设置Titles
                    Chart8.Titles["Title1"].Text = (SysConvert.ToInt32(drpCheckYear.Text) - SysConvert.ToInt32(drpCheckYearNum.Text)).ToString() + "--" + drpCheckYear.Text + "年 月采购量对比曲线图";
                    ...
                    //设置Y轴
                    Chart8.ChartAreas["Default"].AxisY.Title = "采购量";
        ...
        private void CreateChart2(DataTable dt)
        {
            try
            {
                if (dt.Rows.Count > 0)
                {
                    ...
                    if (!chkIndate.Checked)
                    {
                        TitlesTemp = SysConvert.ToString(drpCheckYear.EditValue) + "年采购总数量饼状图";
                    }
                    else
                    {
                        TitlesTemp = SysConvert.ToString(txtQIndateS.DateTime.Date) + "至" + SysConvert.ToString(txtQIndateE.DateTime.Date) + "采购总数量饼状图";
                    }
        ...
        private void CreateChart1(DataTable dt)
        {
            try
            {
                if (dt.Rows.Count > 0)
                {
                    ...
                    if (!chkIndate.Checked)
                    {
                        TitlesTemp = SysConvert.ToString(drpCheckYear.EditValue) + "年采购金额饼状图";
                    }
                    else
                    {
                        TitlesTemp = SysConvert.ToString(txtQIndateS.DateTime.Date) + "至" + SysConvert.ToString(txtQIndateE.DateTime.Date) + "采购金额饼状图";
                    }
