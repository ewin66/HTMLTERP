...
{
	/// <summary>
	/// 目的：Data_ReportFile实体类
	/// 作者:陈加海
	/// 创建日期:2011-11-9
	/// </summary>
	public sealed class ReportFile : BaseEntity
	{
        ...
        /// 构造函数
        /// </summary>
        public ReportFile(IDBTransAccess p_SqlCmd)
		{
		    sqlTrans=p_SqlCmd;
			sqlTransFlag=true;
		}
        ...
        {
            string Sql="SELECT * FROM Data_ReportFile WHERE "+ "ID="+SysString.ToDBString(m_ID);
