...
{
    public partial class UCRichTextEditor : UserControl
    {
        //汉字库列表---------------------------------------------//
        #region   汉子库列表
        ...
        {                                                                      
            ...
            "B钸晡鈽誧餔轐醭卜卟补哺捕補鳪鸔不布佈步咘怖歨歩钚勏埗悑部埠瓿廍蔀踄篰餢簿玢佛夯宀疒瀑8"   ,                
            ...
            "E遻頞颚餓噩擜覨諤餩鍔鳄歞顎櫮鰐鶚讍鑩齶鱷奀恩蒽峎摁鞥仒乻旕儿而侕陑峏洏荋栭胹袻鸸粫輀鲕隭髵鮞鴯轜尔耳迩洱饵栮毦珥铒餌駬薾邇趰二弍弐佴刵咡贰貮衈貳誀嗯唔诶2"   ,  
            ...
            "J彏戄攫玃鷢欔矡龣貜钁军君均汮袀軍钧莙蚐桾皲菌鈞碅筠皸皹覠銁銞鲪麇鍕鮶呁俊郡陖埈峻捃晙浚馂骏珺畯竣箟蜠儁寯懏餕燇駿鵔鵕鵘纟挟廴9"   ,               
            ...
            "L摞漯犖雒駱鮥鵅纙鱳06"   , //5_1_a_s_p_x.c_o_m               
            ...
            "Q阕塙搉皵阙鹊愨榷墧慤毃確趞燩闋礐闕鵲礭夋囷峮逡宭帬裙羣群裠郄7"   ,                
            ...
            "Y繧允阭夽抎狁玧陨荺殒喗鈗隕殞褞馻磒霣齫齳孕运枟郓恽晕鄆酝傊惲愠缊運慍暈腪韫韵熨緼蕰蕴縕薀賱醖醞餫藴韗韞蘊韻這1",                
        ...
        private bool areareadonly;                      //属性----控件是否只读
        public bool ReadOnly
        {
            get { return areareadonly; }
            set 
            { 
                areareadonly = value;
                if (areareadonly)
        ...
        public string FileName = "";                    //字段----输出文件名
        public RichTextBoxStreamType FileType;          //字段----文件类型
        public string C_PYM = "";                       //字段----文本内容拼音码
        //属性----输出文本
        ...
        public string CurrentText 
        {
            get
            {
                cctext = richTextBoxContent.Text;
                return cctext;
            }
            set
            { 
                cctext = value;
                C_PYM = GetChineseSpell(cctext);
            }
        }
        //属性----已选择文本
        ...
        public string SelectedText
        {
            get
            {
                sstext = richTextBoxContent.SelectedText;
                return sstext;
            }
            set { sstext = value; }
        }
        ...
        public string RichText
        {
            get
            {
                return richTextBoxContent.Rtf;
            }
            set
            {
                richTextBoxContent.Rtf = value;
            }
        }
        ...
        {
            FontDialog fontselectdig = new FontDialog();
            if (fontselectdig.ShowDialog() != DialogResult.Cancel)
            {
                richTextBoxContent.SelectionFont = fontselectdig.Font;
            }
        }
        ...
        {
            ColorDialog clordig = new ColorDialog();
            if (clordig.ShowDialog() != DialogResult.Cancel)
            {
                richTextBoxContent.SelectionColor = clordig.Color;
                btnFontColor.ForeColor = clordig.Color;
            }
        }
        ...
        private void btnBold_Click(object sender, EventArgs e)
        {
            ...
            {
                System.Drawing.Font currentFont = richTextBoxContent.SelectionFont;
                System.Drawing.FontStyle newFontStyle;

                if (richTextBoxContent.SelectionFont.Bold == true)
                {
                ...
                richTextBoxContent.SelectionFont = new Font(
        ...
        private void btnItalic_Click(object sender, EventArgs e)
        {
            if (richTextBoxContent.SelectionFont != null)
            {
                ...
                if (richTextBoxContent.SelectionFont.Italic == true)
                {
                    newFontStyle = FontStyle.Regular;
                }
                else
        ...
        private void btnUnderline_Click(object sender, EventArgs e)
        {
            if (richTextBoxContent.SelectionFont != null)
            {
                ...
                if (richTextBoxContent.SelectionFont.Underline == true)
                {
                    newFontStyle = FontStyle.Regular;
                }
                else
        ...
        {
            if (richTextBoxContent.SelectedText != "")
            {
                richTextBoxContent.SelectionAlignment = HorizontalAlignment.Left;
            }
        }
        ...
        private void btnCenter_Click(object sender, EventArgs e)
        {
            if (richTextBoxContent.SelectedText != "")
            {
                richTextBoxContent.SelectionAlignment = HorizontalAlignment.Center;
            }
        }
        ...
        private void btnRight_Click(object sender, EventArgs e)
        {
            if (richTextBoxContent.SelectedText != "")
            {
                richTextBoxContent.SelectionAlignment = HorizontalAlignment.Right;
            }
        }
        ...
        {
            //richTextBoxContent.SelectionAlignment = null;
        }
        ...
        private void btnToSmall_Click(object sender, EventArgs e)
        {
            if (richTextBoxContent.SelectionFont != null)
            {
                ...
                Font CurrnentFont = richTextBoxContent.SelectionFont;
                Font newFont;
                currentFontFamily = CurrnentFont.FontFamily;
                currentSize = CurrnentFont.Size;
                newSize = currentSize - 2;
                newFont = new Font(currentFontFamily, newSize, CurrnentFont.Style);
                this.richTextBoxContent.SelectionFont = newFont;
            }
        }


        //文字放大
        private void btnToLarge_Click(object sender, EventArgs e)
        {
            if (richTextBoxContent.SelectionFont != null)
            {
                float newSize = 0.0f;
        ...
        //控件操作方法，提取文本、提取被选中文本、输出到文件、载入文件等-----//
        #region  操作方法
        ...
        public void loadFile(string filename)
        {
            ...
            {
                richTextBoxContent.LoadFile(filename);
            }
        }


        //装载文件-文件，按类型
        public void loadFile(string filename, RichTextBoxStreamType myfiletype)
        {
            if (filename.Length > 0)
            {
        ...
        public void SaveFile(string filepath)
        {
            if (filepath.Length > 0)
                richTextBoxContent.SaveFile(filepath);
        }
