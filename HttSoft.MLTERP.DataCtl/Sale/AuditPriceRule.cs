...
{
	/// <summary>
	/// 目的：Sale_AuditPrice实体业务规则类
	/// 作者:曹小艮
	/// 创建日期:2011-12-15
	/// </summary>
	public class AuditPriceRule
	{
	    /// <summary>
        /// 构造函数
        /// </summary>
		public AuditPriceRule()
		{
		}
        ...
        public DataTable RShow(string p_condition, string p_FieldName)
        {
            try
            {
                ...
                string sql = "SELECT " + p_FieldName + " FROM Sale_AuditPrice WHERE 1=1";
                sql += p_condition;
        ...
        public DataTable RShowDts(string p_condition, string p_FieldName)
        {
            try
            {
                ...
                string sql = "SELECT " + p_FieldName + " FROM UV1_Sale_AuditPrice WHERE 1=1";
                sql += p_condition;
                return SysUtils.Fill(sql);
            }
            catch (BaseException)
        ...
        public void RAdd(BaseEntity p_BE, BaseEntity[] p_BE2, IDBTransAccess sqlTrans)
        {
            try
            {
                ...
                AuditPriceDtsRule ruledts = new AuditPriceDtsRule();
                ruledts.RSave((AuditPrice)p_BE, p_BE2, sqlTrans);//保存从表
