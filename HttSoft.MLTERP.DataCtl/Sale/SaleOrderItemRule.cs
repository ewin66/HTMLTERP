...
{
	/// <summary>
	/// 目的：Sale_SaleOrderItem实体业务规则类
	/// 作者:章文强
	/// 创建日期:2013/8/14
	/// </summary>
	public class SaleOrderItemRule
	{
	    /// <summary>
        /// 构造函数
        /// </summary>
		public SaleOrderItemRule()
		{
		}
        ...
        public DataTable RShow(string p_condition, string p_FieldName)
        {
            try
            {
                ...
                string sql = "SELECT " + p_FieldName + " FROM Sale_SaleOrderItem WHERE 1=1";
                sql += p_condition;
        ...
        public DataTable RShowU(string p_condition, string p_FieldName)
        {
            try
            {
                ...
                string sql = "SELECT " + p_FieldName + " FROM UV1_Sale_SaleOrderItem WHERE 1=1";
                sql += p_condition;
                return SysUtils.Fill(sql);
            }
            catch (BaseException)
