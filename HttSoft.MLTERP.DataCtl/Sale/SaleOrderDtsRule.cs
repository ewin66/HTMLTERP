...
{
	/// <summary>
	/// 目的：Sale_SaleOrderDts实体业务规则类
	/// 作者:陈加海
	/// 创建日期:2012-4-17
	/// </summary>
	public class SaleOrderDtsRule
	{
	    /// <summary>
        /// 构造函数
        /// </summary>
		public SaleOrderDtsRule()
		{
		}
		...
		{
			SaleOrderDts entity=(SaleOrderDts)p_BE;
		}	
        ...
        public DataTable RShow(string p_condition, string p_FieldName)
        {
            try
            {
                ...
                string sql = "SELECT " + p_FieldName + " FROM Sale_SaleOrderDts WHERE 1=1";
                sql += p_condition;
		...
		public void RAdd(BaseEntity p_BE,IDBTransAccess sqlTrans)
		{
			try
			{
				...
				SaleOrderDts entity=(SaleOrderDts)p_BE;				
				SaleOrderDtsCtl control=new SaleOrderDtsCtl(sqlTrans);
				entity.ID=(int)EntityIDTable.GetID((long)SysEntity.Sale_SaleOrderDts,sqlTrans);
