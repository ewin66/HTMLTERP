...
{
	/// <summary>
	/// 目的：Sale_AuditPriceDts实体业务规则类
	/// 作者:曹小艮
	/// 创建日期:2011-12-15
	/// </summary>
	public class AuditPriceDtsRule
	{
	    /// <summary>
        /// 构造函数
        /// </summary>
		public AuditPriceDtsRule()
		{
		}
		...
		{
			AuditPriceDts entity=(AuditPriceDts)p_BE;
		}	
        ...
        public DataTable RShow(string p_condition, string p_FieldName)
        {
            try
            {
                ...
                string sql = "SELECT " + p_FieldName + " FROM Sale_AuditPriceDts WHERE 1=1";
                sql += p_condition;
		...
		public void RAdd(BaseEntity p_BE,IDBTransAccess sqlTrans)
		{
			try
			{
				...
				AuditPriceDts entity=(AuditPriceDts)p_BE;				
				AuditPriceDtsCtl control=new AuditPriceDtsCtl(sqlTrans);
                //entity.ID=(int)EntityIDTable.GetID((long)SysEntity.Sale_AuditPriceDts,sqlTrans);
