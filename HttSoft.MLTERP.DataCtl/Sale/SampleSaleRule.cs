...
{
	/// <summary>
	/// 目的：Sale_SampleSale实体业务规则类
	/// 作者:邱继中
	/// 创建日期:2014/3/20
	/// </summary>
	public class SampleSaleRule
	{
	    /// <summary>
        /// 构造函数
        /// </summary>
		public SampleSaleRule()
		{
		}
        ...
        public DataTable RShow(string p_condition, string p_FieldName)
        {
            try
            {
                ...
                string sql = "SELECT " + p_FieldName + " FROM Sale_SampleSale WHERE 1=1";
                sql += p_condition;
        ...
        public DataTable RShowDts(string p_condition, string p_FieldName)
        {
            try
            {
                ...
                string sql = "SELECT " + p_FieldName + " FROM UV1_Sale_SampleSaleDts WHERE 1=1";
                sql += p_condition;
                return SysUtils.Fill(sql);
            }
            catch (BaseException)
        ...
        public void RAdd(BaseEntity p_BE, BaseEntity[] p_BE2, IDBTransAccess sqlTrans)
        {
            try
            {
                ...
                SampleSaleDtsRule ruledts = new SampleSaleDtsRule();
                ruledts.RSave((SampleSale)p_BE, p_BE2, sqlTrans);//保存从表
		...
		public void RDelete(BaseEntity p_BE,IDBTransAccess sqlTrans)
		{
			try
			{
                ...
                string sql = "DELETE FROM Sale_SampleSaleDts WHERE MainID=" + entity.ID.ToString();
