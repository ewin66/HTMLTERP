...
{
	/// <summary>
	/// 目的：Sale_OperateQuote实体业务规则类
	/// 作者:曹小艮
	/// 创建日期:2011-11-7
	/// </summary>
	public class OperateQuoteRule
	{
	    /// <summary>
        /// 构造函数
        /// </summary>
		public OperateQuoteRule()
		{
		}
        ...
        public DataTable RShow(string p_condition, string p_FieldName)
        {
            try
            {
                ...
                string sql = "SELECT " + p_FieldName + " FROM UV1_Sale_OperateQuoteDts WHERE 1=1";
                sql += p_condition;
        ...
        public void RAdd(BaseEntity p_BE, BaseEntity[] p_BE2, IDBTransAccess sqlTrans)
        {
            try
            {
                ...
                OperateQuoteDtsRule ruledts = new OperateQuoteDtsRule();
                ruledts.RSave((OperateQuote)p_BE, p_BE2, sqlTrans);//保存从表
		...
		public void RDelete(BaseEntity p_BE,IDBTransAccess sqlTrans)
		{
			try
			{
                ...
                string sql = "DELETE FROM Sale_OperateQuoteDts WHERE MainID=" + entity.ID.ToString();
