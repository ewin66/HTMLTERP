...
{
	/// <summary>
	/// 目的：Att_ProductCheckDts实体业务规则类
	/// 作者:刘德苏
	/// 创建日期:2012/5/8
	/// </summary>
	public class ProductCheckDtsRule
	{
	    /// <summary>
        /// 构造函数
        /// </summary>
		public ProductCheckDtsRule()
		{
		}
        ...
        public DataTable RShow(string p_condition, string p_FieldName)
        {
            try
            {
                ...
                string sql = "SELECT " + p_FieldName + " FROM Att_ProductCheckDts WHERE 1=1";
                sql += p_condition;
