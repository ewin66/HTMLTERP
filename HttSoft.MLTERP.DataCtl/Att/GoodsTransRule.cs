...
{
	/// <summary>
	/// 目的：Att_GoodsTrans实体业务规则类
	/// 作者:陈加海
	/// 创建日期:2012-4-17
	/// </summary>
	public class GoodsTransRule
	{
	    /// <summary>
        /// 构造函数
        /// </summary>
		public GoodsTransRule()
		{
		}
        ...
        public DataTable RShow(string p_condition, string p_FieldName)
        {
            try
            {
                ...
                string sql = "SELECT " + p_FieldName + " FROM UV1_Attn_GoodsTrans WHERE 1=1";
                sql += p_condition;
        ...
        public DataTable RShowDts(string p_condition, string p_FieldName)
        {
            try
            {
                ...
                string sql = "SELECT " + p_FieldName + " FROM UV1_Attn_GoodsTransDts1 WHERE 1=1";
                sql += p_condition;
                return SysUtils.Fill(sql);
            }
            catch (BaseException)
        ...
        public void RUpdate(BaseEntity p_BE, BaseEntity[] p_BE2, IDBTransAccess sqlTrans)
        {
            try
            {
                ...
                //string sql = "DELETE Att_GoodsTransDts WHERE MainID="+SysString.ToDBString(entity.ID);
