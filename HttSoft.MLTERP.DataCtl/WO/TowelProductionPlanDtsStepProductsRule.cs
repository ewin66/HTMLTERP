...
{
	/// <summary>
	/// 目的：WO_TowelProductionPlanDtsStepProducts实体业务规则类
	/// 作者:zhp
	/// 创建日期:2016/9/12
	/// </summary>
	public class TowelProductionPlanDtsStepProductsRule
	{
	    /// <summary>
        /// 构造函数
        /// </summary>
		public TowelProductionPlanDtsStepProductsRule()
		{
		}
        ...
        public DataTable RShow(string p_condition, string p_FieldName)
        {
            try
            {
                ...
                string sql = "SELECT " + p_FieldName + " FROM WO_TowelProductionPlanDtsStepProducts WHERE 1=1";
                sql += p_condition;
        ...
        public void RAdd(BaseEntity[] p_BE, IDBTransAccess sqlTrans)
        {
            try
            {
                ...
                {
                    this.CheckCorrect(p_BE[i]);
                    TowelProductionPlanDtsStepProducts entity = (TowelProductionPlanDtsStepProducts)p_BE[i];
                    TowelProductionPlanDtsStepProductsCtl control = new TowelProductionPlanDtsStepProductsCtl(sqlTrans);
                    entity.ID = (int)EntityIDTable.GetID((long)SysEntity.WO_TowelProductionPlanDtsStepProducts, sqlTrans);
                    control.AddNew(entity);
                }
