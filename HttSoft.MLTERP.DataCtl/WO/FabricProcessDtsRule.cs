...
{
	/// <summary>
	/// 目的：WO_FabricProcessDts实体业务规则类
	/// 作者:翟晓东
	/// 创建日期:2012-8-17
	/// </summary>
	public class FabricProcessDtsRule
	{
	    /// <summary>
        /// 构造函数
        /// </summary>
        public FabricProcessDtsRule()
		{
		}
        ...
        public DataTable RShowYS(string p_condition)
        {
            try
            {
                return RShowYS(p_condition, "*");
            }
            catch (BaseException)
            {
                throw;
        ...
        /// </summary>
        /// <param name="p_condition"></param>
        public DataTable RShowYS(string p_condition, string p_FieldName)
        {
            try
            {
                ...
                string sql = "SELECT " + p_FieldName + " FROM WO_FabricProcessDts WHERE 1=1";
