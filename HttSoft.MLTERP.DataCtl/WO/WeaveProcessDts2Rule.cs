...
{
	/// <summary>
	/// 目的：WO_WeaveProcessDts2实体业务规则类
	/// 作者:翟晓东
	/// 创建日期:2012-8-17
	/// </summary>
	public class WeaveProcessDts2Rule
	{
	    /// <summary>
        /// 构造函数
        /// </summary>
        public WeaveProcessDts2Rule()
		{
		}
		...
		{
			WeaveProcessDts2 entity=(WeaveProcessDts2)p_BE;
		}	
        ...
        public DataTable RShow(string p_condition, string p_FieldName)
        {
            try
            {
                ...
                string sql = "SELECT " + p_FieldName + " FROM WO_WeaveProcessDts2 WHERE 1=1";
                sql += p_condition;
		...
		public void RAdd(BaseEntity p_BE,IDBTransAccess sqlTrans)
		{
			try
			{
				...
				WeaveProcessDts2 entity=(WeaveProcessDts2)p_BE;				
				WeaveProcessDts2Ctl control=new WeaveProcessDts2Ctl(sqlTrans);
                entity.ID = (int)EntityIDTable.GetID((long)SysEntity.WO_WeaveProcessDts2, sqlTrans);
