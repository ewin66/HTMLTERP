...
{
	/// <summary>
	/// 目的：WO_FabricProcessItemDts实体业务规则类
	/// 作者:陈加海
	/// 创建日期:2014/7/15
	/// </summary>
	public class FabricProcessItemDtsRule
	{
	    /// <summary>
        /// 构造函数
        /// </summary>
		public FabricProcessItemDtsRule()
		{
		}
        ...
        public DataTable RShow(string p_condition, string p_FieldName)
        {
            try
            {
                ...
                string sql = "SELECT " + p_FieldName + " FROM WO_FabricProcessItemDts WHERE 1=1";
                sql += p_condition;
