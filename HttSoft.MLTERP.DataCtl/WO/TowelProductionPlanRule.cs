...
{
	/// <summary>
	/// 目的：WO_TowelProductionPlan实体业务规则类
	/// 作者:zhp
	/// 创建日期:2016/8/25
	/// </summary>
	public class TowelProductionPlanRule
	{
	    /// <summary>
        /// 构造函数
        /// </summary>
		public TowelProductionPlanRule()
		{
		}
        ...
        public DataTable RShow(string p_condition, string p_FieldName)
        {
            try
            {
                ...
                //string sql = "SELECT " + p_FieldName + " FROM WO_TowelProductionPlan WHERE 1=1";
                string sql = "SELECT " + p_FieldName + " from  UV1_WO_TowelProductionPlanDts WHERE 1=1";
                sql += p_condition;
        ...
        public void RAdd(BaseEntity p_BE, BaseEntity[] p_BE2, IDBTransAccess sqlTrans)
        {
            try
            {
                ...
                TowelProductionPlanDtsRule ruledts = new TowelProductionPlanDtsRule();
                ruledts.RSave((TowelProductionPlan)p_BE, p_BE2, sqlTrans);//保存从表
