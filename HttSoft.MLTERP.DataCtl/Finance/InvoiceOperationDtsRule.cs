...
{
	/// <summary>
	/// 目的：Finance_InvoiceOperationDts实体业务规则类
	/// 作者:刘德苏
	/// 创建日期:2012/5/8
	/// </summary>
	public class InvoiceOperationDtsRule
	{
	    /// <summary>
        /// 构造函数
        /// </summary>
		public InvoiceOperationDtsRule()
		{
		}
        ...
        public DataTable RShow(string p_condition, string p_FieldName)
        {
            try
            {
                ...
                string sql = "SELECT " + p_FieldName + " FROM UV2_Finance_InvoiceOperationDts WHERE 1=1";
                sql += p_condition;
