...
{
	/// <summary>
	/// 目的：Finance_InvoiceYOperationDts实体业务规则类
	/// 作者:章文强
	/// 创建日期:2012/8/15
	/// </summary>
	public class InvoiceYOperationDtsRule
	{
	    /// <summary>
        /// 构造函数
        /// </summary>
		public InvoiceYOperationDtsRule()
		{
		}
        ...
        public DataTable RShow(string p_condition, string p_FieldName)
        {
            try
            {
                ...
                string sql = "SELECT " + p_FieldName + " FROM Finance_InvoiceYOperationDts WHERE 1=1";
                sql += p_condition;
