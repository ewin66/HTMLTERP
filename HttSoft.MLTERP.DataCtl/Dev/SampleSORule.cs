...
{
	/// <summary>
	/// 目的：Dev_SampleSO实体业务规则类
	/// 作者:邱继中
	/// 创建日期:2014/6/9
	/// </summary>
	public class SampleSORule
	{
	    /// <summary>
        /// 构造函数
        /// </summary>
        ...
        public DataTable RShow(string p_condition, string p_FieldName)
        {
            try
            {
                ...
                string sql = "SELECT " + p_FieldName + " FROM Dev_SampleSO WHERE 1=1";
                sql += p_condition;
        ...
        public DataTable RShowDts(string p_condition, string p_FieldName)
        {
            try
            {
                ...
                string sql = "SELECT " + p_FieldName + " FROM UV1_Dev_SampleSO WHERE 1=1";
                sql += p_condition;
                return SysUtils.Fill(sql);
            }
            catch (BaseException)
        ...
        public void RAdd(BaseEntity p_BE, BaseEntity[] p_BE2, IDBTransAccess sqlTrans)
        {
            try
            {
                ...
                SampleSODtsRule ruledts = new SampleSODtsRule();
                for (int i = 0; i < p_BE2.Length; i++)
                {
                    ((SampleSODts)p_BE2[i]).MainID = ((SampleSO)p_BE).ID;
                    ruledts.RAdd(p_BE2[i], sqlTrans);
                }
                //ruledts.RSave((SampleSO)p_BE, p_BE2, sqlTrans);//保存从表
		...
		public void RDelete(BaseEntity p_BE,IDBTransAccess sqlTrans)
		{
			try
			{
                ...
                string sql = "DELETE FROM Dev_SampleSODts WHERE MainID=" + entity.ID.ToString();
