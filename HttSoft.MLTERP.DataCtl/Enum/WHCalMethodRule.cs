...
{
	/// <summary>
	/// 目的：Enum_WHCalMethod实体业务规则类
	/// 作者:陈加海
	/// 创建日期:2009-4-2
	/// </summary>
	public class WHCalMethodRule
	{
	    /// <summary>
        /// 构造函数
        /// </summary>
		public WHCalMethodRule()
		{
		}
        ...
        public DataTable RShow(string p_condition, string p_FieldName)
        {
            try
            {
                ...
                string sql = "SELECT " + p_FieldName + " FROM Enum_WHCalMethod WHERE 1=1 ";
                sql += p_condition;
		...
		public void RAdd(BaseEntity p_BE,IDBTransAccess sqlTrans)
		{
			try
			{
                ...
                sql = "SELECT ID FROM Enum_WHCalMethod WHERE ID=" + SysString.ToDBString(entity.ID);
                if (sqlTrans.Fill(sql).Rows.Count != 0)
                {
