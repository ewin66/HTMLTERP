...
{
	/// <summary>
	/// 目的：Ship_ShipBoatDts实体业务规则类
	/// 作者:潘杰俊
	/// 创建日期:2009-4-28
	/// </summary>
	public class ShipBoatDtsRule
	{
	    /// <summary>
        /// 构造函数
        /// </summary>
		public ShipBoatDtsRule()
		{
		}
		...
		{
			ShipBoatDts entity=(ShipBoatDts)p_BE;
		}	
        ...
        public DataTable RShow(string p_condition, string p_FieldName)
        {
            try
            {
                ...
                string sql = "SELECT " + p_FieldName + " FROM Ship_ShipBoatDts WHERE 1=1";
                sql += p_condition;
		...
		public void RAdd(BaseEntity p_BE,IDBTransAccess sqlTrans)
		{
			try
			{
				...
				ShipBoatDts entity=(ShipBoatDts)p_BE;				
				ShipBoatDtsCtl control=new ShipBoatDtsCtl(sqlTrans);
				//entity.ID=(int)EntityIDTable.GetID((long)SysEntity.Ship_ShipBoatDts,sqlTrans);
