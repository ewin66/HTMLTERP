...
{
	/// <summary>
	/// 目的：Ship_ShipBoat实体业务规则类
	/// 作者:潘杰俊
	/// 创建日期:2009-4-28
	/// </summary>
	public class ShipBoatRule
	{
	    /// <summary>
        /// 构造函数
        /// </summary>
        ...
        public DataTable RShow(string p_condition, string p_FieldName)
        {
            try
            {
                ...
                string sql = "SELECT " + p_FieldName + " FROM UV1_Ship_ShipBoat WHERE 1=1";
                sql += p_condition;
        ...
        public void RAdd(BaseEntity p_BE, BaseEntity[] p_BE2, IDBTransAccess sqlTrans)
        {
            try
            {
                ...
                ShipBoatDtsRule ruledts = new ShipBoatDtsRule();
                ruledts.RSave((ShipBoat)p_BE, p_BE2, sqlTrans);//保存从表
