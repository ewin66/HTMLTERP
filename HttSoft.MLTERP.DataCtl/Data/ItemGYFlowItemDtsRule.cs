...
{
	/// <summary>
	/// 目的：Data_ItemGYFlowItemDts实体业务规则类
	/// 作者:陈加海
	/// 创建日期:2014/6/20
	/// </summary>
	public class ItemGYFlowItemDtsRule
	{
	    /// <summary>
        /// 构造函数
        /// </summary>
		public ItemGYFlowItemDtsRule()
		{
		}
        ...
        public DataTable RShow(string p_condition, string p_FieldName)
        {
            try
            {
                ...
                string sql = "SELECT " + p_FieldName + " FROM Data_ItemGYFlowItemDts WHERE 1=1";
                sql += p_condition;
