...
{
	/// <summary>
	/// 目的：Data_ItemDts实体业务规则类
	/// 作者:陈加海
	/// 创建日期:2012-4-18
	/// </summary>
	public class ItemDtsRule
	{
	    /// <summary>
        /// 构造函数
        /// </summary>
        ...
        public DataTable RShow(string p_condition, string p_FieldName)
        {
            try
            {
                ...
                string sql = "SELECT " + p_FieldName + " FROM Data_ItemDts WHERE 1=1";
                sql += p_condition;
		...
		public void RAdd(BaseEntity p_BE,IDBTransAccess sqlTrans)
		{
			try
			{
				...
				ItemDts entity=(ItemDts)p_BE;				
				ItemDtsCtl control=new ItemDtsCtl(sqlTrans);
				entity.ID=(int)EntityIDTable.GetID((long)SysEntity.Data_ItemDts,sqlTrans);
