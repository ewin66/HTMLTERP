...
{
	/// <summary>
	/// 目的：Data_VendorAddress实体业务规则类
	/// 作者:周富春
	/// 创建日期:2011/11/29
	/// </summary>
	public class VendorAddressRule
	{
	    /// <summary>
        /// 构造函数
        /// </summary>
		public VendorAddressRule()
		{
		}
		...
		{
			VendorAddress entity=(VendorAddress)p_BE;
		}	
        ...
        public DataTable RShow(string p_condition, string p_FieldName)
        {
            try
            {
                ...
                string sql = "SELECT " + p_FieldName + " FROM Data_VendorAddress WHERE 1=1";
                sql += p_condition;
		...
		public void RAdd(BaseEntity p_BE,IDBTransAccess sqlTrans)
		{
			try
			{
				...
				VendorAddress entity=(VendorAddress)p_BE;				
				VendorAddressCtl control=new VendorAddressCtl(sqlTrans);
                //entity.ID=(int)EntityIDTable.GetID((long)SysEntity.Data_VendorAddress,sqlTrans);
