...
{
	/// <summary>
	/// 目的：Data_CompanyAccount实体业务规则类
	/// 作者:潘杰俊
	/// 创建日期:2009-4-16
	/// </summary>
	public class CompanyAccountRule
	{
	    /// <summary>
        /// 构造函数
        /// </summary>
		public CompanyAccountRule()
		{
		}
        ...
        public DataTable RShow(string p_condition, string p_FieldName)
        {
            try
            {
                ...
                string sql = "SELECT " + p_FieldName + " FROM UV1_Data_CompanyAccount WHERE 1=1";
                sql += p_condition;
