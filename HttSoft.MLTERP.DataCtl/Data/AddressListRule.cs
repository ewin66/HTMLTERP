...
{
	/// <summary>
	/// 目的：Data_AddressList实体业务规则类
	/// 作者:lirm
	/// 创建日期:2013-1-30
	/// </summary>
	public class AddressListRule
	{
	    /// <summary>
        /// 构造函数
        /// </summary>
		public AddressListRule()
		{
		}
        ...
        public DataTable RShow(string p_condition, string p_FieldName)
        {
            try
            {
                ...
                string sql = "SELECT " + p_FieldName + " FROM UV1_Data_AddressListDts WHERE 1=1";
                sql += p_condition;
        ...
        public void RAdd(BaseEntity p_BE, BaseEntity[] p_BE2, IDBTransAccess sqlTrans)
        {
            try
            {
                ...
                AddressListDtsRule ruledts = new AddressListDtsRule();
                ruledts.RSave((AddressList)p_BE, p_BE2, sqlTrans);//保存从表
		...
		public void RDelete(BaseEntity p_BE,IDBTransAccess sqlTrans)
		{
			try
			{
                ...
                string sql = "DELETE FROM Data_AddressListDts WHERE MainID=" + entity.ID.ToString();
