...
{
	/// <summary>
	/// 目的：Data_VendorTypeForm实体业务规则类
	/// 作者:潘杰俊
	/// 创建日期:2009-4-9
	/// </summary>
	public class VendorTypeFormRule
	{
	    /// <summary>
        /// 构造函数
        /// </summary>
		public VendorTypeFormRule()
		{
		}
        ...
        public DataTable RShow(string p_condition, string p_FieldName)
        {
            try
            {
                ...
                string sql = "SELECT " + p_FieldName + " FROM UV1_Data_VendorTypeForm WHERE 1=1";
                sql += p_condition;
