...
{
	/// <summary>
	/// 目的：Data_BugForm实体业务规则类
	/// 作者:邱继中
	/// 创建日期:2014/3/20
	/// </summary>
	public class BugFormRule
	{
	    /// <summary>
        /// 构造函数
        /// </summary>
        ...
        public DataTable RShow(string p_condition, string p_FieldName)
        {
            try
            {
                ...
                string sql = "SELECT " + p_FieldName + " FROM Data_BugForm WHERE 1=1";
                sql += p_condition;
        ...
        public DataTable RShowDts(string p_condition, string p_FieldName)
        {
            try
            {
                ...
                string sql = "SELECT " + p_FieldName + " FROM UV1_Data_BugForm WHERE 1=1";
                sql += p_condition;
                return SysUtils.Fill(sql);
            }
            catch (BaseException)
