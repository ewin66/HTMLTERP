...
{
	/// <summary>
	/// 目的：Data_SaleFlowModule实体业务规则类
	/// 作者:chengtb
	/// 创建日期:2014-4-18
	/// </summary>
	public class SaleFlowModuleRule
	{
	    /// <summary>
        /// 构造函数
        /// </summary>
		public SaleFlowModuleRule()
		{
		}
        ...
        public DataTable RShow(string p_condition, string p_FieldName)
        {
            try
            {
                ...
                string sql = "SELECT " + p_FieldName + " FROM Data_SaleFlowModule WHERE 1=1";
                sql += p_condition;
        ...
        public void RAdd(BaseEntity p_BE, BaseEntity[] p_BE2, IDBTransAccess sqlTrans)
        {
            try
            {
                ...
                SaleFlowModuleDtsRule ruledts = new SaleFlowModuleDtsRule();
                ruledts.RSave((SaleFlowModule)p_BE, p_BE2, sqlTrans);//保存从表
