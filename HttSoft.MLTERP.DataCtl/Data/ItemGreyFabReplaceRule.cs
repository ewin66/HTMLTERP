...
{
	/// <summary>
	/// 目的：Data_ItemGreyFabReplace实体业务规则类
	/// 作者:陈加海
	/// 创建日期:2014/7/2
	/// </summary>
	public class ItemGreyFabReplaceRule
	{
	    /// <summary>
        /// 构造函数
        /// </summary>
		public ItemGreyFabReplaceRule()
		{
		}
        ...
        public DataTable RShow(string p_condition, string p_FieldName)
        {
            try
            {
                ...
                string sql = "SELECT " + p_FieldName + " FROM UV1_Data_ItemGreyFabReplace WHERE 1=1";
                sql += p_condition;
